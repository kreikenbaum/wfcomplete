...
function _init() {
    // testing    const HTML_JSON = [["http://127.0.0.1:1234/", 1000], ["https://shavar.services.mozilla.com/downloads", 200]];
    // testing    const NUM_EMBEDDED_JSON = [["http://127.0.0.1:1234/tmptest.html", 30]];
