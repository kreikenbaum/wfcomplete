    ...
    3. [@3] Code lay-out
	  ...
	  - [if example one style]
	    #+BEGIN_SRC python
		  ...
		  do_something()
	    #+END_SRC
** MOVE TO MDN [[../../../chive/developer.mozilla.org/en-US/docs/User:wbamberg/Macros/API/page-mod.html][page-mod]] - Mozilla | MDN
*** summary
    - Globals
...
*** summary
    ...
    8) Basic Priciples
       ...
       - honest measurement
         ...
         - to a that is measurable scale ("two weeks" instead of
           "14.176 hours")
