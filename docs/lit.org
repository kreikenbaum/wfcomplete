...
*** quotes
    ...
    - (ends 3)
** TODO [#B] [[./cacr2015-08.pdf][Walkie-Talkie: An Effective and Efficient Defense against Website Fingerprinting]]
*** summary
    0) [@0] ABSTRACT
...
*** ref
    ...
    #+END_SRC
** [[./irbookonlinereading.pdf][An Introduction to Information Retrieval]]
*** summary
*** quotes
    - Most commonly, the edit operations allowed for this purpose are:
      ...
      issometimes known as *Levenshtein distance*.
...
** TODO MOVE [#A] [[./ESLII_print4.pdf][The Elements of Statistical Learning]]
*** summary
*** quotes
 ...
 | email |   1.27 | 1.27 | 0.44 | 0.90 | 0.07 | 0.43 | 0.11 | 0.18 | 0.42 | 0.29 |   0.01 | 
    ...
    - ("ends" ch 1)
    - We will see that high variance and overfitting are a major
