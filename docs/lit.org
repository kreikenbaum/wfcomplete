...
** TODO MOVE [[./platform_xpcom - Mozilla | MDN.html][platform/xpcom]]
*** summary
    1) Usage
...
** MOVE [[./wtfpad-setup.pdf][Setup der Obfuscation-Tools]]
*** summary
...
*** quotes
    3) [@3] Aufsetzen von Juarez’ WTFPAD-Tools
	 ...
	 #+END_SRC
*** TODO ref
** [[./Curose-Ross - Computer_Networking_-_A_Top-down_Approach_Featuring_the_Internet__Third_Edition.pdf]]
*** summary (up to p.103)
