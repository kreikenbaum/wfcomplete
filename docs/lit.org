    ...
    5) [@5] EVALUATING HYPOTHESES
	  ...
	  0) [@0]
	     ...
	     - estimate difference d = error_D(h_1) - error_D(h_2)
	       ...
	       - variance of d^ is sum of variances of error_{S_{i}}(h_i)
...
** TODO MOVE [[./usersrouted-ccs13.pdf][Johnson - Users Get Routed: Traffic Correlation on Tor by Realistic Adversaries]]
*** summary
    0) [@0] ABSTRACT
...
** MOVE PART (picture): [[./10_3-ndss2016-slides.pdf][Panchenko - Website Fingerprinting at Internet Scale Presentation]]
*** ref  https://www.internetsociety.org/sites/default/files/10_3-ndss2016-slides.pdf
** TODO [#A] [[./DOM3-Core.pdf][Document Object Model (DOM) Level 3 Core Specification]]
*** summary
...
*** quotes
	...
	1) [@3] Encrypting Communications Channels
...
** TODO [#A] [[~/da/git/docs/onion.pdf][Anonymous Connections and Onion Routing]]
*** summary
    0) [@0] Abstract
