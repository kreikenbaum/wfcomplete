...
** TODO MOVE [#B] [[./Vorratsdatenspeicherung – Wikipedia.html][Wikipedia - Vorratsdatenspeicherung]]
*** summary
    0) [@0]
...
*** TODO [#A] 6.2.1 and 5.(1 ?) more thoroughly, then add to [[file:~/da/git/diplomarbeit.org::*(maybe)%20vs%20Optimal%20Attacker][(maybe) vs Optimal Attacker]]
*** TODO [#B] order quotes
*** summary
    0) [@0] ABSTRACT
...
** PART MOVE [[file:master.bib::time2-manual][time Linux Programmers Manual]]
*** quotes
