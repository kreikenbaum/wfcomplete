...
*** summary
    - [[file:///usr/share/doc/python-matplotlib-doc/html/api/pyplot_api.html][plot]]
      - with one data array, setting color from color_cycle, and transparency
        ...
        #+END_SRC
*** quotes
** [[../../../chive/GG/it/LaTeX/Symbols/symbols.pdf][The Great, Big List of \LaTeX Symbols]]
*** quotes
    14) [@14] Delimiters
        - \langle =\ langle=
        - \rangle =\ rangle=
...
*** quotes
*** ref
** [[./TAIntro-book.pdf][Introducing Traffic Analysis]]
*** summary
*** quotes
*** ref
** [[./traffic.pdf][Traffic Analysis Attacks and Trade-Offs in Anonymity Providing Systems]]
*** summary
*** quotes
*** ref
