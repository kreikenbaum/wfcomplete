...
*** TODO summary
    ...
    3) FEATURES AND METHODOLOGY
	  ...
	  - several generators
	    ...
	    - small changes G_{1}: length + v, upto MTU
	    - large changes G_{2}: length + 1000, upto MTU
	    - length diffusion G_{3}: increased by position i/5, upto MTU
	    - append packets G_{4}: length MTU
*** quote
