...
*** TODO quotes
	...
	can be used to achieve the same goal since
        ...
        f (x) > 0 ⇐⇒ p(y = 1|x) > 0.5
      - (ends 2.2.5)
** MOVE [[./ieee-icc15.pdf][A First-Hop Traffic Analysis Attack Against Tor]]
*** summary
    0) [@0] Abstract
...
*** quotes
    ...
    - (ends 4.D (=4.4))
** TODO [#B] [[./cacr2015-08.pdf][Wang - Walkie-Talkie: An Effective and Efficient Defense against Website Fingerprinting]]
*** summary
    0) [@0] ABSTRACT
...
**** ref
     ...
     #+END_SRC
*** [[~/da/git/docs/onion.pdf][Anonymous Connections and Onion Routing]]
**** summary
     0) [@0] Abstract
