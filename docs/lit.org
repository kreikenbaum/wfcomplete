...
** MOVE [#A] [[./HTTP Traffic Model_v1 1 white paper.pdf][Lee - A NEW TRAFFIC MODEL FOR CURRENT USER WEB BROWSING BEHAVIOR]]
*** summary
    0) [@0] ABSTRACT
...
*** summary
    ...
    4) Strukturmuster (hier weiter)
	  ...
	  - Interaktion: abstraktion leite anfragen (von klienten) weiter
...
*** summary
    ...
    6) Active attacks
       ...
       - impose timing signature via active dropping
...
*** quotes
    ...
    - (ends 8)
** [#B] MOVE PART [[./javascript_the_good_parts.pdf][JavaScript: The Good Parts]]
*** summary
    1. Good parts
