...
** TODO [#A] [[./ccs14.pdf][Cai 2014 - A Systematic Approach to Developing and Evaluating Website Fingerprinting Defenses]]
*** TODO [#A] 5.1.2+ and 6.2.1 thoroughly, then add to [[file:~/da/git/diplomarbeit.org::*(maybe)%20vs%20Optimal%20Attacker][(maybe) vs Optimal Attacker]]
    continue at theorem 2
*** TODO [#B] order quotes
*** summary
    0) [@0] ABSTRACT
...
** TODO [#A] PART [[./hastie.pdf][Hastie - The Elements of Statistical Learning]]          :ML:
...
*** TODO [#A] skim Section 13.3 (knn)
*** TODO [#B] sort unsorted quotes
*** summary
    1) Introduction
...
** TODO [#A] PART [[../../../chive/GG/it/emacs/org.pdf][Dominik - The Org Manual]]
*** TODO [#A] views (for priority a items in da.org (and lit.org))
*** summary
    1) Introduction
...
** TODO [#B] PART [[./user_guide_0.16.1.pdf][Pedregosa - scikit-learn user guide]]
...
***** Solution
      ...
      #+END_SRC
** TODO [#B] [[./icml-tutorial.pdf][Christiani - Support Vector and Kernel Machines]]
*** continue page 26
*** quotes
    - A Little History
...
** PART MOVE [[./harry.pdf][Rieck - Harry Version 0.4.2]]
*** quotes
    3) [@3] DESCRIPTION
...
** PART MOVE [[./2016-jmlr.pdf][Harry: A Tool for Measuring String Similarity]]
*** summary
    0) [@0] Abstract
