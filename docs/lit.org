...
** TODO [#A] [[file:/home/web/Desktop/thesishelp/aristolo-100-thesis-masterplan.pdf][Gerlach - thesis-masterplan]]
   - phasen 1--8
    ...
    4. [@4] Linear Methods for Classification
       ...
       5. Separating Hyperplanes
          ...
          2. Optimal Separating Hyperplanes
             ...
             - replace ||\beta||=1 to
               #+BEGIN_SRC latex
                 y_i(x_i^T\beta + \beta_0) \ge  ||\beta|| (ref:esl-4.47)
               #+END_SRC
...
** TODO [#B] [[~web/Desktop/thesis/1708.06376.pdf][Automated Website Fingerprinting through Deep Learning]]
