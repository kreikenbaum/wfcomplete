...
** TODO MOVE [#B] [[./user_guide_0.16.1.pdf][Pedregosa - scikit-learn user guide]]
...
***** Solution
      ...
      #+END_SRC
** TODO MOVE [#B] [[./LiuSIGIR2010.pdf][Liu - Understanding web browsing behaviors through Weibull analysis of dwell time]]
...
*** ref: C. Liu, R. White, and S. Dumais. Understanding web browsing
      ...
      pages 379–386, 2010.
** TODO [#A] [[./ton96.pdf][Crovella - Self-Similarity in World Wide Web Traffic: Evidence and Possible Causes]]
...
** TODO MOVE [[./Vorratsdatenspeicherung – Wikipedia.html][Wikipedia - Vorratsdatenspeicherung]]
*** summary
    0. [@0]
...
** TODO MOVE [#A] [[./Axelsson.pdf][Axelsson - The Base-Rate Fallacy and its Implications for the Difficulty of Intrusion Detection]]
...
*** summary
    0. [@0] Abstract
       ...
       - to achieve good bayesian detection rate, P(Intrusion|Alarm),
         ...
         - (== P(sensitive website|classified as such))
