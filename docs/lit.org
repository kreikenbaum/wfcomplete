...
*** TODO summary (weiter bei 0.4.3.Beispielcode S.206)
    0) [@0] Preface
       1) Vorwort
...
** MOVE [#A] [[./hintz02.pdf][Hintz - Fingerprinting Websites Using Traffic Analysis]]
*** summary
    0) [@0] Abstract
...
*** summary
    ...
    8) Creation and management of dummy packets
       ...
       - simplest: creation by mix, but nonforwardeable

       - pre-computed on generation and times of quiet
...
** PART MOVE [[./Quantile%20function%20-%20Wikipedia,%20the%20free%20encyclopedia.html][Quantile function]]
*** summary
    1) Definition
...
** PART MOVE [[./diveintopython.pdf][Dive Into Python]]
*** summary
    8) [@8] HTML Processing
