...
*** summary
    8. [@8] Object-oriented Programming
       ...
       - easy: just attach name to object
	 ...
	 - use with =new()=
       ...
       - .prototype always changes object, object never changes .prototype
...
** TODO MOVE [[./ton96.pdf][Self-Similarity in World Wide Web Traffic: Evidence and Possible Causes]]
*** summary
*** quotes
