...
** TODO [#A] [[file:~/da/git/sw/p/classifier/script/eval.py][Panchenko - eval.py]]
*** summary
    - imports
      ...
      - # main code
        ...
        - else (open world)
          ...
          - open foreground file (=Generating FG-Features=)
            - =featuresFG=: count to class name (line.split(' ')[1:])
...
** PART [#B]  [[/usr/share/doc/python-sklearn-doc/stable/index.html][Pedregosa - scikit-learn user guide]] [0/3] also as 0.16 [[./user_guide_0.16.1.pdf][pdf]]
...
***** Solution
      ...
      #+END_SRC
** PART [#E] [[/usr/share/doc/texlive-doc/generic/pgf/pgfmanual.pdf][Tantau - The TikZ and PGF Packages]]
*** summary
