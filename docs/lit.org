...
*** quotes
    ...
    - (ends 4.D (=4.4))
** PART MOVE DOWN [#B] [[./random.pdf][Computer Generation of Statistical Distributions]]
*** quotes
...
*** ref
    ...
    #+END_SRC
** TODO MOVE [#B] [[./oakland2012-peekaboo.pdf][Dyer - Peek-a-Boo, I Still See You: Why Efficient Traffic Analysis Countermeasures Fail]]
*** summary
    0) [@0] Abstract
...
** PART [#B] [[./javascript_the_good_parts.pdf][JavaScript: The Good Parts]]
*** summary
    1. Good parts
...
** TODO [#A] MOVE [[./HTTP Traffic Model_v1 1 white paper.pdf]]
*** summary
    0) [@0] ABSTRACT
