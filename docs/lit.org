...
*** TODO summary (weiter bei Besucher.Motivation, S. 301)
    0) [@0] Preface
...
** TODO [#B] [[/home/chive/own/tor/doc/read/tor-spec.txt][Tor Protocol Specification]]
*** [#B] read through to 3, see that correct
*** summary
    0) [@0] Preliminaries:
...
** TODO search feature vs classifier MOVE [[./2009-diss.pdf][Machine Learning for Application-Layer Intrusion Detection]]
*** summary
*** quotes
