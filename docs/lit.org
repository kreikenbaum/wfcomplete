...
*** TODO [#A] 5.1.2+ and 6.2.1 thoroughly, then add to [[file:~/da/git/diplomarbeit.org::*(maybe)%20vs%20Optimal%20Attacker][(maybe) vs Optimal Attacker]]
    - continue at "This theorem enables us to efficiently compute a
      lower bound on"
*** TODO [#B] order quotes
*** summary
    0) [@0] ABSTRACT
...
** TODO MOVE [#A] PART [[./hastie.pdf][Hastie - The Elements of Statistical Learning]]     :ML:
    ...
    4) Helpful Hints
       ...
       9. [@9] It’s best to use the three-letter abbreviations for the
          ...
          #+BEGIN_EXAMPLE
            month = jul # "~4,"
          #+END_EXAMPLE
** TODO MOVE [#B] PART [[./user_guide_0.16.1.pdf][Pedregosa - scikit-learn user guide]]
