...
*** summary
    ...
    updated daily
** MOVE [[./JavaScript Garden.html][Wetzel - JavaScript Garden]]
*** summary
    1) Objects
...
*** quotes
    6) Other
       - Note: As setTimeout takes a function object as its first
         ...
         any error.
** MOVE [[./tf-idf.html][Wiki - term frequency–inverse document frequency]]
*** quotes
...
** MOVE [[./Security best practices in extensions - Mozilla | MDN.html][wbamberg - Security best practices in extensions - Mozilla | MDN]]
*** summary
    0) [@0]
...
** MOVE [[./cacr2015-08.pdf][Wang - Walkie-Talkie: An Effective and Efficient Defense against Website Fingerprinting]]
*** summary
    0) [@0] ABSTRACT
...
** TODO MOVE PART [#C] [[./thebook.pdf][Smola - INTRODUCTION TO MACHINE LEARNING]] [0/2]
