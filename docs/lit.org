...
*** #B PART search feature vs classifier
*** summary
    1) Introduction
...
** TODO MOVE [#C] [[~/da/git/docs/onion.pdf][Anonymous Connections and Onion Routing]]
*** summary
    0) [@0] Abstract
...
** TODO [[./TAIntro-book.pdf][Danezis - Introducing Traffic Analysis]]
*** summary
    1) Introduction
...
*** summary
    ...
    6) [@6] Model selection and evaluation
       ...
       2) [@2] Grid Search: Searching for estimator parameters
...
** [[./Hypertext Style: Cool URIs don't change..html][Cool URIs don't change]]
*** ref [[file:master.bib::cooluri][Berners-Lee 1998: Cool URIs]]
** PART MOVE [[/usr/share/doc/texlive-doc/generic/pgf/pgfmanual.pdf][The TikZ and PGF Packages]]
*** summary
...
*** quotes
    0) [@0] Prolog
       6) [@6] Resümee
          - Es ist auch naiver Empirismus, zur Untermauerung irgendeiner
            Argumentation Reihen beredsamer bestätigender Zitate von
            toten Autoritäten anzuführen.
          - Wenn man danach sucht, kann man immer jemand finden, der
            eine wohlklingende Feststellung gemacht hat, die den
            eigenen Standpunkt stützt; außerdem ist es bei jedem Thema
            möglich, einen anderen toten Denker zu finden, der genau
