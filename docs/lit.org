#+PRIORITIES: A S S
#+TODO: DOC PART TODO | DONE PENDING
[[./master.bib]]
# * sort first by [alpha(a), then] prio (p), then by todo state reversed (O)
* [[~/chive/locallit.org]]
* TODO [#B] lit [58/427]                                                :lit:
** DONE [[Arp - diplomarbeit_kommentare_von_daniel.pdf]]
...
** DONE [[~/da/git/sw/LLaMA/README.md][Cherubin - (Github) LLaMA, A Tor Browser add-on to hamper website fingerprinting]]
*** quotes
...
** DONE [[./9501101.pdf][Dietterich - Solving Multiclass Learning Problems via Error-Correcting Output Codes]]
*** summary
    1. Introduction
...
** DONE [[file:/home/web/Desktop/thesis/thesishelp/aristolo-ebook-06-bachelor-master-thesis-in-31-tagen-text.pdf::1][Gerlach - bachelor-master-thesis-in-31-tagen]]
*** summary
    Phasen
...
*** quotes
    - class EvalOption
      ...
      - self.folds = 10
** DONE [[file:../sw/p/feature-scripts/generate-feature.py][Panchenko - generate-feature.py]]
*** summary
     0) [@0] import
...
** DONE [[file:../sw/p/feature-scripts/outlier-removal.py][Panchenko - outlier-removal.py]]
    <<outlier-removal>>
*** summary
     1) import stuff
...
** DONE [[~web/Desktop/thesis/1708.06376.pdf][Rimmer - Automated Website Fingerprinting through Deep Learning]]
*** summary
    0. [@0] Abstract
...
** TODO [[./cacr2014-05.pdf][Wang - Effective Attacks and Provable Defenses for Website Fingerprinting]] [0/2]
...
** TODO [#A] [[~web/Downloads/uml/UMLBasics.pdf][Bell - UML basics: An introduction to the Unified Modeling Language]]
*** summary
    0. [@0]
...
** TODO [#B] [[file:/home/web/Desktop/thesis/thesishelp/aristolo-ebook-01-Machs-68-techniken-gegen-aufschieberei-text-1.pdf][Gerlach - Machs-68-techniken-gegen-aufschieberei]]
*** summary
...
** TODO [#B] [[file:/home/web/Desktop/thesis/thesishelp/aristolo-114-noten-anforderungen.pdf][Gerlach - noten-anforderungen]]
*** quotes
    1. Sehr gut
...
** TODO [#B] Kahneman - Schnelles Denken, langsames Denken
...
*** quotes
    0. [@0] Einleitung
       - man strebt viel eher nach Perfektion, wenn man sich nicht
         langweilt
** TODO [#B] [[/home/web/keep/thesis/2016_ML1/][Kloft - ML 1]]
*** Lesson 1
    - teaser
    - defs
...
*** [[/home/web/keep/thesis/2016_ML1/Lecture02.pdf][Lesson 2 - Linear Classifiers]]
    ...
    - Gradient Descent
      - stochastic gradient descent: randomly draw i.i.d. sample, descend
        - paralellizable
*** [[file:/home/web/keep/thesis/2016_ML1/Lecture03.pdf][Lesson 3]]
    - last lesson: linear classifiers, f(x) = sgn(w^T x+b)
      - fast + simple
      - centroid: f(x) =  arg min_{y \in {-, +}} ||x - c_{y}||
      - svm: separate data with largest margin
        - fast, simple + accurate
    n  - hard-margin-svm misclassify with outliers, fix with error terms
...
** TODO [#B] [[~web/Desktop/thesis/10.1.1.115.3644.pdf][Müller - An Introduction to Kernel-Based Learning Algorithms]]
*** summary
    1. Introduction
       - SVMs,
...
** TODO [#B] [[./ThesisWritingHints.new_model_etc.pdf][Ratiu - Hints for writing a PhD thesis]]
*** summary
...
** TODO [#C](skim) [[./it2013..kloft_phd.pdf][Kloft - Kernel-Based Machine Learning with Multiple Sources of Information]]
*** summary
    0. [@0] Summary
...
** TODO [#C] [[~web/Desktop/thesis/2017_sp_nnrobustattacks.pdf][Carlini - Towards Evaluating the Robustness of Neural Networks]]
** TODO [#C] [[./tor-design.pdf][Dingledine - Tor: The Second-Generation Onion Router]]
*** summary
    2. [@2] Related work
...
** TODO [#C] [[./duda-etal-00.pdf][Duda - Pattern Classification]] [0/1]                         :ML:
...
** TODO [#C] [[./Thesis Writing-A Guide.pdf][Gruen - Thesis Writing]]
...
** TODO [#C] [[/home/web/keep/thesis/2015_ML2/][Kloft - ML 2]]
...
** TODO [#C] [[./SS03.pdf][Passive Attack Analysis for Connection-Based Anonymity Systems]]
*** summary
*** quotes
*** ref [[file:master.bib::SS03][Serjantov & Sewell 2003: Passive Attack Analysis]]
** TODO [#C] [[./201101-Evaluation_JMLT_Postprint-Colour.pdf][Powers - Evaluation: from precision, recall and f-measure to roc, informedness, markedness & correlation]]
...
** TODO [#C] [[./2009-diss.pdf][Rieck - Machine Learning for Application-Layer Intrusion Detection]]
*** summary
    0. [@0] Summary
...
*** summary
    ...
    4. ADVERSARY MODELS
       ...
       B. Knowledge classification
          ...
          - CONTINUE HERE
*** quotes
** TODO [#C] [[./10.1.1.60.7300.measureanon.pdf][Towards measuring anonymity]]
*** summary
*** quotes
*** ref [[file:master.bib::Diaz02towardsmeasuring][Diaz et al. 2002: Towards Measuring Anonymity]]
** TODO (ch2+3) [#D] [[file:/home/web/Desktop/thesis/thesishelp/aristolo-100-thesis-masterplan.pdf][Gerlach - thesis-masterplan]]
   - phasen 1--8
   - jetzt: 3: Kapitel 2 und 3 schreiben, link:
** TODO [#D] [[./esa2006b.pdf][An Improved Construction for Counting Bloom Filters]]
** TODO [#D] [[~/da/git/docs/onion.pdf][Anonymous Connections and Onion Routing]]
*** summary
    0. [@0] Abstract
...
** TODO [#D] [[./einserkandidat.de/blog/thesis-maschine/index.html][Baulig - Thesis-Maschine 3.0]]
...
** TODO [#D] [[~web/keep/thesis/Bishop - Pattern Recognition And Machine Learning - Springer  2006.pdf][Bishop - Pattern Recognition and Machine Learning]] [0/1]
*** TODO [#C] skim
*** ref [[file:master.bib::bishop2007pattern][Bishop 2007: Pattern Recognition Machine]]
** TODO [#D] [[./10.1.1.20.98.bloom-nw.pdf][Broder - Network Applications of Bloom Filters: A Survey]]
   continue at 5.3
*** summary
    0. [@0] Abstract
       - "space efficient"
...
** TODO [#D] [[./george-thesis.pdf][Danezis - Better Anonymous Communications]]
*** TODO [#B] skim
*** ref [[file:master.bib::george-thesis][Danezis 2004: Better Anonymous Communications]]
** TODO [#D] [[./Oya.pdf][Do dummies pay off-Limits of dummy traffic protection in anonymous communications]]
*** summary
    0. [@0] Abstract
...
** TODO [#D] [[./ethical.html][Ethical Tor Research: Guidelines]]
*** summary
...
** TODO [#D] [[./1410.2087v3.pdf][Feghhi - A Web Traffic Analysis Attack Using Only Timing Information]]
*** summary
    0. [@0] Abstract
...
** TODO [#D] [[./webtiming.pdf][Felten - Timing Attacks on Web Privacy]]
*** ref [[file:master.bib::DBLP:conf/ccs/FeltenS00][Felten & Schneider 2000: Timing Web]]
** TODO [#D] [[~web/keep/thesis/Geman92.pdf][Geman - Neural networks and the bias/variance dilemma]] [0/1]
*** TODO [#C] skim
*** ref [[file:master.bib::geman1992neural][Geman et al. 1992: Neural]]
** TODO [#D] [[./hastie.pdf][Hastie - The Elements of Statistical Learning]]  [0/5]        :ML:
*** TODO [#D] skim Section 13.3 (knn)
*** TODO [#E] Sections 5.8, 14.5.4, 18.5 and Chapter 12
*** TODO [#E] skim 2.9, 3.3, 6.7, 7 (esp 7.10), 9, 12 and 13, 15, 16
    (leave out 11,14,17)
...
** TODO [#D] [[./usersrouted-ccs13.pdf][Johnson - Users Get Routed: Traffic Correlation on Tor by Realistic Adversaries]]
*** summary
    0. [@0] ABSTRACT
...
** TODO [#D] [[./LiuSIGIR2010.pdf][Liu - Understanding web browsing behaviors through Weibull analysis of dwell time]]
*** summary
    0. [@0] ABSTRACT
...
*** ref: C. Liu, R. White, and S. Dumais. Understanding web browsing
      ...
      pages 379–386, 2010.
** TODO [#D] [[./LZCLCP_NDSS11.pdf][Luo - HTTPOS: Sealing Information Leaks with Browser-side Obfuscation of Encrypted Flows]]
*** summary
    0. [@0] Abstract
...
** TODO [#D] [[./xxx-multihop-padding-primitives.txt][Multihop Padding Primitives]]
*** summary
...
*** TODO ref
** TODO [#D] [[./oakland05torta.pdf][Murdoch - Low-Cost Traffic Analysis of Tor]]
*** summary
*** quotes
*** ref [[file:master.bib::torta05][Murdoch & Danezis 2005: Low Cost Traffic Analysis Tor]]
** TODO [#D] [[./Polya_HowToSolveIt.pdf][Polya - How To Solve It]]
*** skim to find separation-quote (or use ocr)
** TODO [#D] Schölkopf - Learning with Kernels [0/2]                     :ML:
...
** TODO [#D] [[./browser.html][The Design and Implementation of the Tor Browser]]
*** summary
    1. Introduction
...
** TODO [#D] [[./ssh-use01.pdf][Timing Analysis of Keystrokes and Timing Attacks on SSH]]
*** summary
*** quotes
*** ref [[file:master.bib::DBLP:conf/uss/SongWT01][Song et al. 2001: Timing Analysis Keystrokes]]
** TODO [#D] [[~/da/git/docs/timing-fc2004.pdf][Timing Attacks in Low-Latency Mix Systems]]
** TODO [#D] [[./traffic.pdf][Traffic Analysis Attacks and Trade-Offs in Anonymity Providing Systems]]
*** summary
*** quotes
*** ref [[file:master.bib::back01][Back et al. 2001: Traffic Analysis Attacks]]
** TODO [#D] [[./802163c-01_30r1.pdf][Traffic Model for 802.16 TG3 MAC/PHY Simulations]]
*** summary
    1. Introduction
       - model (wireless WAN)
       - one direction only
...
** TODO [#D] [[./voydock.pdf][Voydock - Security Mechanisms in High-Level Network Protocols]]
*** ref
...
** TODO [#D] [[./cacr2015-09.pdf][Wang - On Realistically Attacking Tor with Website Fingerprinting]]
*** summary
    0. [@0] Abstract
       - laboratory vs real
...
** TODO [#D] [[./wright-passive.pdf][Wright - Defending Anonymous Communications Against Passive Logging Attacks]]
*** summary
    0. [@0] Abstract
...
** TODO [#E] [[./guyon03a.pdf][An Introduction to Variable and Feature Selection]]
...
** TODO [#E] [[./EdmanS09.pdf][AS-awareness in Tor Path Selection]]
...
** TODO [#E] [[./rfc3986.html][Berners-Lee - Uniform Resource Identifier (URI): Generic Syntax]]
*** summary
    0. [@0] Abstract
    ...
    2. Characters
       2. [@2] Reserved Characters
          - reserved    = gen-delims / sub-delims
            ...
            sub-delims  = "!" / "$" / "&" / "'" / "(" / ")"
                        / "*" / "+" / "," / ";" / "="
** TODO [#E] blocking.pdf: Design of a blocking-resistant anonymity system
*** TODO refactor
*** quotes
*** summary
    1. Introduction
...
** TODO [#E] [[./randomforest2001.pdf][Breiman - RANDOM FORESTS]]
*** summary
*** quotes
...
** TODO [#E] [[./p434.pdf][Casalicchio - A client-aware dispatching algorithm for web clusters providing multiple services]]
*** summary
    0. [@0] ABSTRACT
...
** TODO [#E] control-spec.txt
*** TODO refactor
*** summary
    0. communication with locally running Tor process
*** quotes
** TODO [#E] [[./pets2011-defenestrator.pdf][DefenestraTor: Throwing out Windows in Tor]]
*** TODO refactor
*** quotes
    0. [@0] unsorted
...
** TODO [#E] [[./E.W. Dijkstra Archive  On the role of scientific thought (EWD447).html][Dijkstra - On the role of scientific thought]]
** TODO [#E] [[./geurtz.pdf][Geurts - Extremely randomized trees]]
*** summary
    0. [@0] Abstract
...
** TODO [#E] [[~/da/git/docs/mlj12.pdf][Good edit similarity learning by loss minimization]]
** TODO [#E] [[./www.ted.com/talks/glenn_greenwald_why_privacy_matters/transcript.html][Greenwald:privacy]]
*** summary
...
** TODO [#E] [[./Curose-Ross - Computer_Networking_-_A_Top-down_Approach_Featuring_the_Internet__Third_Edition.pdf][Kurose - Computer Networking: A Top-Down Approach Featuring the Internet]]
*** TODO [#D] http
*** summary (up to p.103)
...
** TODO [#E] [[./move-ndss.pdf][M O V E: An End-to-End Solution To Network Denial of Service]]
** TODO [#E] [[./McGrawHill_-_Machine_Learning_-Tom_Mitchell.pdf][Mitchell - Machine Learning]]  [0/3]                          :ML:
...
** TODO [#E] [[./torspec/proposals/ideas/xxx-using-spdy.txt][Murdoch - Using the SPDY protocol to improve Tor performance]]
*** ref [[file:master.bib::tor-spec-spdy][Murdoch 2010: Using SPDY Tor]]
** TODO [#E] [[/usr/share/doc/python-sklearn-doc/stable/index.html][Pedregosa - scikit-learn user guide]] [0/5]
*** also as 0.16 [[./user_guide_0.16.1.pdf][pdf]]
*** TODO [#D] scikit read up on 5.7.2 outlier detection
    [2017-03-26 So]
...
***** Solution
      ...
      #+END_SRC
** TODO [#E] [[./Applied_Cryptography.pdf][Schneier - Applied Cryptography]] [0/1]
...
** TODO [#E] [[./numprint.pdf][The numprint package]] [0/1]
...
** TODO [#E] [[./top_ml_algo.pdf][Top 10 algorithms in data mining]]
** TODO [#F] [[https://trac.torproject.org/projects/tor/ticket/8470#comment:7][#8470 Request randomization a lot less random in FF17]]
   local: [[./lessrand.html]]
*** quotes
    - [...] the browser is often too slow to be able to keep the
      ...
      combining to happen.
** TODO [#F] chaum-mix.pdf: Untraceable Electronic Mail, Return Addresses and Digital Pseudonyms
*** TODO refactor
*** summary
...
** TODO [#F] [[./crov1297.pdf][Crovella - Long-Lasting Transient Conditions in Simulations with Heavy-Tailed Workloads]]
*** summary
    0. [@0] ABSTRACT
...
*** summary
    0. Scope and preliminaries
     ...
     1. ...
*** quotes
** TODO [#F] Malamud - Privacy and Private States
*** summary
*** quotes
    - Primo Levi observed that "solitude in a Camp is more precious
      and rare than bread."
** TODO [#F] [[./minion-design.pdf][Mixminion: Design of a Type III Anonymous Remailer Protocol]]
...
** TODO [#F] [[./crowds.pdf][Reiter - Crowds: Anonymity for Web Transactions]]
*** ref [[file:master.bib::crowds:tissec][Reiter & Rubin 1998: Crowds]]
** TODO [#F] [[./torspec/tor-spec.txt][Tor Protocol Specification]]
*** TODO refactor
...
** PART [[./PEP 3333 -- Python Web Server Gateway Interface v1.0.1 | Python.org.html]]
*** summary
*** quotes
...
** PART [[./Receiver operating characteristic - Wikipedia.html]]
*** quotes
    0. [@0]
...
*** summary
    ...
    - colormap(hot);
    - colorbar;
** PART [[./Sensitivity and specificity - Wikipedia.fpr_etc.html]]
*** summary
    0. [@0]
...
** PART [[~/da/git/docs/10.1.1.96.7225.pdf][A Guided Tour to Approximate String Matching]]
*** quotes
...
** PART [[/usr/share/doc/texlive-doc/latex/amsmath/amsldoc.pdf][AMS - User’s Guide for the amsmath Package]]
*** summary
...
** PART [[/usr/share/doc/RFC/informational/rfc1945.txt.gz][Berners-Lee - Hypertext Transfer Protocol -- HTTP/1.0]]
*** summary
*** quotes
...
** PART [[file:/usr/share/doc/RFC/best-current-practice/rfc2119.txt.gz][Bradner - Key words for use in RFCs to Indicate Requirement Levels]]
*** summary
*** quotes
...
** PART [[/home/uni/chive/GG/it/misc/rfc7159.json-storage-and_xfer.txt][Bray - The JavaScript Object Notation (JSON) Data Interchange Format]]
*** summary
    0. [@0] Abstract
...
** PART [#E] developer.mozilla.org [0/1]
...
*** window/utils
    - getWindowLoadingContext(window)
      ...
      - Returns
        nsILoadContext
*** PART [#D] [[../../../chive/developer.mozilla.org/en-US/docs/MDN/Contribute/Guidelines/Style_guide.html][Writing style guide]]
**** summary
     1. Basics
        1. Page titles
...
*** quotes
*** ref
** PART [[./DOM3-Core.pdf][Document Object Model (DOM) Level 3 Core Specification]]
*** summary
...
** PART [[~/chive/GG/it/web-html_css_http_js/Ecma-262.pdf][ECMAScript Language Specification]]
*** summary
...
** PART [[file:/usr/share/doc/RFC/proposed-standard/rfc7231.txt.gz][Fielding - RFC 7231 - Hypertext Transfer Protocol (HTTP/1.1): Semantics and Content]]
*** summary
    3. [@3] Representations
...
** PART [[./js/javascript%20-%20Firefox%20Addon%20observer%20http-on-modify-request%20not%20working%20properly%20-%20Stack%20Overflow.html][Firefox Addon observer http-on-modify-request not working properly]]
*** quotes
    - set up
      #+BEGIN_SRC javascript
        httpRequestObserver =
    ...
    - unload register
      ...
      #+END_SRC
*** TODO ref
** PART [[~web/Desktop/thesis/Foss S., Korshunov D., Zachary S. An introduction to heavy-tailed and subexponential distributions (Springer, 2011)(ISBN 1441994726)(O)(134s)_MV_.pdf][Foss - An Introduction to Heavy-Tailed and Subexponential Distributions]]
*** summary
...
** PART [[~web/Desktop/thesis/thesishelp/aristolo-ebook-08-dissertation-in-200-tagen.pdf][Gerlach - dissertation-in-200-tagen]]
...
*** quotes
    - For a manpage from a particular section, use either of the
      ...
      cat(1)
      1 cat
** PART [[./single-page.html][Hickson - HTML 5]]
*** summary
*** quotes
...
*** quotes
    ...
    27. Bei LATEX gehts rund — grau und bunt
        - Zum Farbdrucken eines Textes können Sie den Befehl
          \textcolor{farbe}{text}
          benutzen.
** PART [[~web/keep/thesis/PhDthesis.pdf][Kloft - l_{p} -Norm Multiple Kernel Learning]]
*** summary
    1. Introduction and Overview
       1. Introduction
...
** PART [[./Levenshtein.html][Levenshtein-Distanz]]
*** quotes
...
** PART [[./Masterthesis.pdf][Malte Hübner - Automatische Erkennung von anormalen Android-Anwendungen]]
   :PROPERTIES:
   :CUSTOM_ID: malte
   :Effort:   20:00
   :END:
...
** PART [[./marionette_client.pdf][Marionette Python Client Documentation]]
*** summary
    0. [@0]
...
** PART [[./torspec/proposals/001-process.txt][Mathewson - The Tor Proposal Process]]
...
** PART [[./Z5280B.pdf][Mitroff - Dirty Rotten Strategies - How We Trick Ourselves and Others into Solving the Wrong Problems Precisely]]
*** summary
*** quotes
...
*** ref
** PART [[~web/Desktop/thesis/ADA460282.pdf][Newton - Preserving Privacy by De-identifying Facial Images]]
...
** PART [[./ipccc12-tor-performance.pdf][Panchenko - Improving Performance and Anonymity in the Tor Network]]
*** ref [[file:master.bib::ipccc12-performance][Panchenko et al. 2012: Improving Performance Anonymity Tor Network]]
** PART [[file:../sw/p/extract-scripts/parse-tcp.py][Panchenko - parse-tcp.py]]
*** quotes
...
** PART [[file:../sw/p/extract-scripts/raw-to-tcp.py][Panchenko - raw-to-tcp.py]]
...
** PART [[/home/web/keep/thesis/The Open Society And Its Enemies.pdf][Popper - The Open Society and its Enemies - 1 The Spell of Plato]]
*** summary
    0. [@0] Preface to the Second Edition
...
** PART [[./python-doc-howto-functional.pdf][Rossum - Functional Programming HOWTO]]
*** quotes
...
** PART Sarle - Neural Network FAQ Part 1
*** summary
    1. Introduction
...
** PART [[./Sauro_Lewis_CHI2010..geom_mean.pdf][Sauro - Average Task Times in Usability Tests: What to Report?]]
*** summary
    0. [@0] Abstract
...
** PART shadow-ndss2012.pdf: Shadow: Running Tor in a Box for Accurate and Efﬁcient Experimentation
*** TODO refactor
*** summary
    1. Introduction:
...
** PART [[./p5-extended.pdf][Sherwood - P5 : A Protocol for Scalable Anonymous Communication]]
...
*** quotes
    - You pass a metric as metric param, and additional metric
      ...
      #+END_SRC
** PART [[~web/Desktop/thesis/SokolovaLapalme-JIPM09.pdf][Sokolova - A systematic analysis of performance measures for classification tasks]]
*** summary
    1. Motivation
...
** PART [[./Solove154U.Pa.L.Rev.477(2006)..privacy_taxonomy.pdf][Solove - A Taxonomy of Privacy]]
*** summary
    0. [@0]
...
** PART [[~web/Desktop/thesis/glossariesbegin.pdf][Talbot - The glossaries package v4.35: a guide for beginners]]
*** summary
    0. [@0] Abstract
       - glossaries complex
       - this: brief intro
    ...
    1. Getting Started
       ...
       - in headings: use =\glsentrytext= for glossary entries and
         ...
         acronyms.
*** quotes
** PART [[/home/web/keep/thesis/glossaries-user.pdf][Talbot - User Manual for glossaries.sty v4.35]]
*** quotes
...
** PART [[./projects.html][The Tor Project - Software & Services]]
*** summary
    - Tor Browser
...
** PART [[/home/web/Desktop/thesis/icons/Tor Style Guide v1.3.pdf][The Tor Project - Tor Style guide]]
*** quotes
    - Colors
      - Primary: Tor Purple
...
** PART [[./Turing_Paper_1936.pdf][Turing - On Computable Numbers, with an Application to the Entscheidungsproblem]]
*** summary
...
*** quotes
    ...
    - Disable offloads:
      ...
      #+END_SRC
** PART [[/home/uni/chive/someday/layered-grammar.pdf][Wickham - A Layered Grammar of Graphics]]
*** summary
    0. [@0] Abstract
...
** PART [[./tidy-data.pdf][Wickham - Tidy Data]]
*** summary
    0. [@0]
       - tidy data:
...
** PART [[./Vorratsdatenspeicherung – Wikipedia.html][Wikipedia - Vorratsdatenspeicherung]]
*** summary
    0. [@0]
...
** PART [#F] Gamma - Entwurfsmuster [0/1]
*** TODO [#F] weiter bei Besucher, S. 317
*** summary
    0. [@0] Preface
       1. Vorwort
...
** DOC [#C] [[/home/web/keep/thesis/f156cdc8a479aa994eae875a0860d663d317.pdf][Schölkopf - Learning with Kernels (slides)]]
...
** DOC [[file:Regularization%20(mathematics)%20-%20Wikipedia,%20the%20free%20encyclopedia.html][file:~/da/git/docs/Regularization (mathematics) - Wikipedia, the free encyclopedia.html]]
** DOC [[file:/home/web/Desktop/thesis/thesishelp/aristolo-510-abbildungen-formatierung.pdf][Gerlach - abbildungen-formatierung]]
...
** DOC [[file:/home/web/Desktop/thesis/thesishelp/aristolo-113-mythen-der-thesis.pdf][Gerlach - mythen-der-thesis]]
...
** DOC [[./thesis_-_How_to_explain_things_in_the_motivation_section_of_a_mathematical_paper_without_proper_definitions_-_Academia_Stack_Exchange.write_thesis_intro.html][How to explain things in the motivation section of a mathematical paper without proper definitions?]]
...
** DOC [[~web/Desktop/thesis/2011-DataWrangling-IVJ.pdf][Kandel - Research directions in data wrangling: Visualizations and transformations for usable and credible data]]
...
** DOC [[./libsvm.pdf][LIBSVM: A Library for Support Vector Machines]]
...
** DOC [[./Top changes in Tor since the 2004 design paper (Part 1) | The Tor Blog.html][Mathewson - Top changes in Tor since the 2004 design paper (Part 1)]]
** DOC [[./Top changes in Tor since the 2004 design paper (Part 2) | The Tor Blog.html][Mathewson - Top changes in Tor since the 2004 design paper (Part 2)]]
...
** DOC [[~web/Desktop/thesis/mori.pdf][Mori - Writing a thesis with LaTeX]]
** DOC [[./supersequence.pdf][On the Approximation of Shortest Common Supersequences and Longest Common Subsequences]]
** DOC [[~/da/git/docs/onion-discex00.pdf][Onion Routing Access Configurations]]
...
** DOC [[/home/web/Desktop/thesis/pordn.pdf][Prüfungsordnung für den Diplomstudiengang Informatik]]
** DOC [[./reftex.pdf][RefTeX Manual]]
** DOC [[file:/home/web/Desktop/thesis/ADA606588..rsa_paper.pdf][Rivest - A method for obtaining digital signatures and public-key cryptosystems]]
*** ref [[file:master.bib::rivest1978method][Rivest et al. 1978]]
** DOC [[./2012-jmlr.pdf][Sally: A Tool for Embedding Strings in Vector Spaces]]
...
** DOC [[/home/web/Desktop/thesis/sordn.pdf][Studienordnung für den Diplomstudiengang Informatik]]
** DOC [[./ide883.pdf][Superposition of Interrupted Poisson Processes and Its Application to Packetized Voice Multiplexers]]
** DOC [[/usr/share/doc/texlive-doc/latex/algorithmicx/algorithmicx.pdf][The algorithmicx package]]
** DOC [[./Tor Project: Overview.html][Tor: Overview]]
