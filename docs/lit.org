...
** TODO MOVE [#A] [[./2009-diss.pdf][Rieck - Machine Learning for Application-Layer Intrusion Detection]]
*** [#A] PART 1.2.
*** summary
    0) [@0] Summary
    ...
    1) Introduction
       ...
       2) Machine Learning
          ...
          0) [@0]
             ...
             - mitchell def: learning model, error function, prediction function
