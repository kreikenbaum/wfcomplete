...
** MOVE [[./ronathan-heyning.pdf][Cheng - Traffic Analysis of SSL Encrypted Web Browsing]]
*** summary
    0) [@0] Abstract
...
** TODO [#B] search feature vs classifier [[./2009-diss.pdf][Rieck - Machine Learning for Application-Layer Intrusion Detection]]
*** #B PART
*** summary
    1) Introduction
...
** TODO MOVE [[./SS03.pdf][Passive Attack Analysis for Connection-Based Anonymity Systems]]
*** summary
*** quotes
