...
** TODO MOVE [#B] [[./p434.pdf][Casalicchio - A client-aware dispatching algorithm for web clusters providing multiple services]]
*** TODO [#B] (was C) skim for [[file:~/da/git/diplomarbeit.org::#HTTP%20traffic%20model][HTTP traffic model]]
*** summary
    0. [@0] ABSTRACT
...
** TODO [#A] [[./Axelsson.pdf][Axelsson - The Base-Rate Fallacy and its Implications for the Difficulty of Intrusion Detection]]
*** TODO (was #B) [#A] understand base rate fallacy intellectually
*** summary
    0. [@0] Abstract
...
** TODO [#A] [[/home/web/keep/roc.pdf][Fawcett - An introduction to ROC analysis]]
*** summary
...
*** TODO [#B] skim for [[file:~/da/git/diplomarbeit.org::#HTTP%20traffic%20model][HTTP traffic model]], check that only dwell time, if so (#C)
*** summary
    0. [@0] ABSTRACT
...
*** TODO [#A] (was C) skim for [[file:~/da/git/diplomarbeit.org::#HTTP%20traffic%20model][HTTP traffic model]]
*** summary
    0. [@0] Abstract
    ...
    2. Background
       ...
       2. Statistical Tests For Self-Similarity
          ...
          1. variance-time plot: decreases slowly with slope (- \beta). If
             \beta > -1, self-similar
