...
** MOVE TODO [#B] [[./duda-etal-00.pdf][Duda - Pattern Classification]]
...
***** Solution
      ...
      #+END_SRC
** TODO [#A] [[./LiuSIGIR2010.pdf][Liu - Understanding web browsing behaviors through Weibull analysis of dwell time]]
*** TODO [#A] (was B) skim for [[file:~/da/git/diplomarbeit.org::#HTTP%20traffic%20model][HTTP traffic model]]
