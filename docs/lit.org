...
** TODO PART MOVE [#B] Schölkopf - Learning with Kernels
*** [#B] chapter 7.4 (p.200)
...
*** summary
    ...
    4) IP-Vorratsdatenspeicherung
       ...
       - Loesungsvorschlag ohne IT-Vorratsdatenspeicherung : spezielle
         IT-Forensik
*** quotes
...
**** quotes
     2) [@2] Part II: Parameter Selection Tools
        ...
        2) Example
           ...
           #+END_SRC
** TODO [#B] [[./wright-passive.pdf][Wright - Defending Anonymous Communications Against Passive Logging Attacks]]
*** summary
    0) [@0] Abstract
