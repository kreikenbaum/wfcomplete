...
*** TODO quotes
    ...
    7) Linear Models
       - A *hyperplane* in a space H endowed with a dot product <·, ·>
         ...
         #+BEGIN_SRC latex
           {x ∈ H| <w, x> + b = 0} (ref:ml-7.1)
         #+END_SRC
         where w ∈ H and b ∈ R.
       - Given a set X = {x_1, ..., x_m}, the *margin* is the distance
         of the closest point in X to the hyperplane [[(ml-7.1)]].
         #+BEGIN_SRC latex
           min_{i=1,...,m} \frac{|<w, x_i> + b|}{\|w\|}. (ref:ml-7.2)
         #+END_SRC
** TODO MOVE [[./Oya.pdf][Do dummies pay off-Limits of dummy traffic protection in anonymous communications]]
*** summary
    0) [@0] Abstract
...
** TODO MOVE [#B] [[./10.1.1.20.2080.bloom_orig.pdf][Bloom - Space/Time Trade-offs in Hash Coding with Allowable Errors]]
*** summary
    0) [@0] Abstract
...
*** quotes
    ...
    15) [@15] GENERIC OPERATING SYSTEM SERVICES
	   ...
	   1) Process Parameters
        ...
        2) [@3] time — Time access and conversions
...
** PART [[/usr/lib/python2.7/dist-packages/Gnuplot/demo.py][haggerty - python-gnuplot's demo.py -- Demonstrate the Gnuplot python module]]
   :PROPERTIES:
   :ORDERED:  t
   :END:
*** summary
*** quotes
    ...
    - Save what we just plotted as a color postscript file.
      ...
      #+END_SRC
** PART [[/usr/lib/python2.7/dist-packages/Gnuplot/test.py][haggerty - python-gnuplot's test.py -- Exercise the Gnuplot.py module]]
*** summary
...
*** summary
    - [[file:///usr/share/doc/python-matplotlib-doc/html/api/pyplot_api.html][plot]]
      - with one data array, setting color from color_cycle, and transparency
        ...
        #+END_SRC
*** quotes
** [[../../../chive/GG/it/LaTeX/a026.pdf][Jürgens - LATEX — eine Einführung und ein bisschen mehr ...]]
*** summary
