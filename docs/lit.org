...
*** TODO summary (weiter bei 0.4.5.Konsequenzen S.229)
    0) [@0] Preface
       1) Vorwort
...
*** quotes
    6) Other
       - Note: As setTimeout takes a function object as its first
         ...
         any error.
** MOVE [#A] [[./webfingerprint-wpes.pdf][Improved Website Fingerprinting on Tor]]
*** summary
    0) [@0] Abstract
...
** TODO [#A] MOVE PART -s 1,5,7 [[./McGrawHill_-_Machine_Learning_-Tom_Mitchell.pdf]]
*** summary
    1) INTRODUCTION
...
** TODO [#A] PART MOVE [[./Truncated distribution - Wikipedia, the free encyclopedia.html]]
*** quotes
    1) Definition
