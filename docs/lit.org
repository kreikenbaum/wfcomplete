    ...
    2) [@2] Grundlagen
       ...
       1) Methoden zur Anomalieerkennung
          ...
          2) Eingabedaten für SVMs und andere Methoden in Eingabe-,
             ...
             - weiter: Eingaberaum \cal X: (Menge aller) Merkmale
*** quotes
*** ref: [[file:master.bib::malte][Hübner 2014: Automatische Erkennung Android Anwendungen]]
** MOVE [[../sw/w/knn/README][Wang - README in knn.zip]]
*** quotes
    1. run
...
** TODO [#B] [[./browser.html][The Design and Implementation of the Tor Browser]]
*** summary
    1) Introduction
...
*** quotes
** TODO [#B] PART developer.mozilla.org
...
*** window/utils
    - getWindowLoadingContext(window)
      ...
      - Returns
        nsILoadContext
*** TODO (part) [#B] [[../../../chive/developer.mozilla.org/en-US/docs/MDN/Contribute/Guidelines/Style_guide.html][Writing style guide]]
**** summary
     1) Basics
        1) Page titles
...
** MOVE [[../sw/p/classifier/README.txt][Pancheko - classifier/README.txt]]
*** summary
