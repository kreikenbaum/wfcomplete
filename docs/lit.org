...
*** quotes
*** ref
** PART MOVE Beck - extreme Programming explained                     :hobby:
*** summary
...
** TODO MOVE 2009-03-11-performance.pdf: Performance Improvements on Tor or, Why Tor is slow and what we’re going to do about it
*** TODO refactor
*** summary
...
*** quotes
    ...
    - If web-browsing users are more sensitive to latency than
      ...
      than throughput.
*** TODO ref plus file
** TODO MOVE blocking.pdf: Design of a blocking-resistant anonymity system
*** TODO refactor
*** quotes
*** summary
    1) Introduction
...
*** summary
    ...
    3) Tor’s Approach to Congestion and Flow Control
	  ...
	  - ....
** TODO MOVE shadow-ndss2012.pdf: Shadow: Running Tor in a Box for Accurate and Efﬁcient Experimentation
*** TODO refactor
*** summary
    1) Introduction:
...
** TODO MOVE chaum-mix.pdf: Untraceable Electronic Mail, Return Addresses and Digital Pseudonyms
*** TODO refactor
*** summary
...
** TODO MOVE control-spec.txt
*** TODO refactor
*** summary
    0) communication with locally running Tor process
*** quotes
** TODO MOVE dir-spec.txt
*** TODO refactor
*** summary
    0) Scope and preliminaries
     ...
     1) ...
*** quotes
** PART MOVE [[./201335142847631.pdf][Lohr - Sampling: Design and Analysis]]
** PART MOVE [[/usr/lib/python2.7/dist-packages/Gnuplot/demo.py][haggerty - python-gnuplot's demo.py -- Demonstrate the Gnuplot python module]]
   :PROPERTIES:
   :ORDERED:  t
   :END:
*** summary
*** quotes
    ...
    - Save what we just plotted as a color postscript file.
      ...
      #+END_SRC
** PART MOVE [[/usr/lib/python2.7/dist-packages/Gnuplot/test.py][haggerty - python-gnuplot's test.py -- Exercise the Gnuplot.py module]]
*** summary
