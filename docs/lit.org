...
*** summary
    ...
    1) [@1] Einfuehrung
	  ...
	  13) Itertor: sequentieller zugriff ohne details zu kennen
...
** TODO MOVE [#C] [[./morphing09.pdf][Traffic Morphing: An Efficient Defense Against Statistical Traffic Analysis]]
*** summary
    0. [@0] Abstract
...
** PART MOVE [#B] [[./ESLII_print4.pdf][The Elements of Statistical Learning]]
*** summary
    1) Introduction
...
*** quotes
    ...
    - (ends 2.6.0)
    - (ends 18.1)
** PART MOVE [#B] [[./thebook.pdf][INTRODUCTION TO MACHINE LEARNING]] [0/2]
*** TODO summary
    1) Introduction
...
** PART MOVE [#C] [[./irbookonlinereading.pdf][An Introduction to Information Retrieval]]
*** summary
    0. [@0] Preface
...
**** [[developer.mozilla.org/en-US/Add-ons/SDK/Tools/console.html][console]] ([[file:///home/chive/IT-gg/js/Mozilla_Addon_SDK_doc/developer.mozilla.org/en-US/Add-ons/SDK/Tools/console.html][local link]])
     ...
     - When you install an add-on into Firefox, the logging level will
       ...
       the console.
** PART MOVE [[file:///home/chive/IT-gg/js/Eloquent%20JavaScript/contents.html][Eloquent Javascript]]
*** summary
	...
	- function with workarounds for IE
	...
	- "When creating new nodes" weiter
*** quotes
    - (begins 4)
