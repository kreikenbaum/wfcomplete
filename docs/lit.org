    ...
    1. Introduction
       2. [@2] An Example
          ...
          - These features (or, more precisely, the values of these
            ...
            the species.
       3. The Sub-problems of Pattern Classification
          - an ideal feature extractor would yield a representation
            that makes the job of the classifier trivial; conversely,
            an omnipotent classifier would not need the help of a
            sophisticated feature extractor. The distinction is forced
