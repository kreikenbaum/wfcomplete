...
*** TODO summary
    ...
    7) Linear Models
       ...
       1) Support Vector Classification
          ...
          - soft margin: y_i(<w, xi> +b) \ge 1 - \zeta_i, with

            - minimize: 1/2 ||w||^2 + C/m \sum_{i=1}^{m} \zeta_i

          - continue at 167 after lagrangian
*** TODO quotes
    1) Introduction
       1) A Taste of Machine Learning
          0) [@0]
