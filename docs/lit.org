...
** TODO [#B] [[~/chive/keepimport/Thesis Writing-A Guide.pdf][Gruen - Thesis Writing]]
*** summary
...
** TODO [#B] [[./hastie.pdf][Hastie - The Elements of Statistical Learning]]  [0/5]        :ML:
*** TODO [#B] kloft: (Section *12.2*)
         ...
         - best function f minimizes expected error/risk
           ...
           - control complexity by Vapnik-Chervonenkis (VC) theory and
             ...
             - R[f] \le R_{emp}[f] + \radic((h (ln (2n/h) +1) - ln (\delta /4))/n)
               - the simpler the class the higher Remp, the lower the sqrt
               - vice versa
...
** DOC [[/home/web/keep/thesis/f156cdc8a479aa994eae875a0860d663d317.pdf][Schölkopf - Learning with Kernels (slides)]]
