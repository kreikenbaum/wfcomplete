...
** [[/usr/lib/python2.7/dist-packages/Gnuplot/demo.py][haggerty - python-gnuplot's demo.py -- Demonstrate the Gnuplot python module]]
*** summary
*** quotes
    ...
    - Save what we just plotted as a color postscript file.
      ...
      #+END_SRC
**  [[/usr/lib/python2.7/dist-packages/Gnuplot/test.py][haggerty - python-gnuplot's test.py -- Exercise the Gnuplot.py module]]
*** summary
