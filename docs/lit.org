...
*** [[file:/home/web/keep/thesis/2016_ML1/Lecture03.pdf][Lesson 3]]
    ...
    - convex function f: R^d \to R all points between are aboe graph
...
*** quotes
    - Primo Levi observed that "solitude in a Camp is more precious
      and rare than bread."
** TODO [#F] [[file:///usr/share/doc/python-matplotlib-doc/html/index.html][matplotlib]] [0/1]
