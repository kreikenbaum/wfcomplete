...
** PART [[~web/keep/thesis/02__GOOD_Russel=Norvig=Artificial Intelligence A Modern Approach (3rd Edition).pdf][Russel - Artificial Intelligence A Modern Approach (3rd Edition)]]
*** quotes
