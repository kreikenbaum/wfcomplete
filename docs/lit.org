...
*** ref
    [[file:./master.bib::ccs2014-critical][Juarez et al. 2014: Critical Evaluation Website Fingerprinting Attacks]]
...
** TODO [[./1512.00524v1.pdf][Juarez - WTF-PAD: Toward an Efficient Website Fingerprinting Defense for Tor]]
*** summary
    0) [@0] Abstract
...
** [[./HTTP Traffic Model_v1 1 white paper.pdf][A NEW TRAFFIC MODEL FOR CURRENT USER WEB BROWSING BEHAVIOR]]
*** summary
    0) [@0] ABSTRACT
...
*** summary
    ...
    4) Strukturmuster (hier weiter S. 167)
	  ...
	  - Struktur + Teilnehmer:
	    ...
	    - implementierer-kindklassen benutzen nur operationsImp

	  - Interaktion: ... td (s.190)
...
** MOVE [#A] [[./ndss16-wfp-internet-scale.pdf][Website Fingerprinting at Internet Scale]]
*** summary
    0) [@0] Abstract
...
*** quotes
** TODO [#A] [[./10.1.1.10.5823.pdf][Quantifying Traffic Analysis of Encrypted Web-Browsing]]
*** summary
    0. [@0] Abstract
...
** TODO [#A] [[./hintz02.pdf][Hintz - Fingerprinting Websites Using Traffic Analysis]]
*** summary
    0) [@0] Abstract
...
** TODO MOVE [#B] [[./usersrouted-ccs13.pdf][Users Get Routed: Traffic Correlation on Tor by Realistic Adversaries]]
*** summary
    0) [@0] ABSTRACT
...
** TODO MOVE [#A] [[./webfingerprint-wpes.pdf][Improved Website Fingerprinting on Tor]]
*** summary
    0) [@0] Abstract
    ...
    2) RELATED WORK
       ...
       1) Defenses
*** quotes
    - dynamic content such as advertisements may cause a variation in
      incoming packets but not outgoing packets, and dynamic content
      is often loaded last in a website.
*** ref
...
** MOVE [#C] [[./torproject.orgSLASHaboutSLASHtorusers.html][Who uses Tor?]]
*** summary
    1) Inception
...
** TODO MOVE [#C] [[./pam2014-tor-nfattack.pdf][On the Effectiveness of Traffic Analysis Against Anonymity Networks Using Flow Records]]
*** ref
...
** PART MOVE [[./Google%20Python%20Style%20Guide.html][Google Python Style Guide]]
*** summary
...
** TODO MOVE [[./1999-35.pdf][A Behavioral Model of Web Traffic]]
** [[./tcpdump.pdf]]
...
*** quotes
** TODO MOVE [#B] [[./Analysis_of_Web_Data_Compression_and_its_Impact_on_Traffic_and_Energy_Consumption.pdf]]
*** summary
*** quotes
** PART MOVE Applied Cryptography
*** summary
