#+TODO: TODO MOVE | DONE
[[./master.bib]]
** TODO [#A] move MOVE sections, also in master.bib
...
*** TODO ref [[file:master.bib::kfingerprint][Hayes & Danezis]]
    there is arXiv:1509.00789v3 [cs.CR] 19 Feb 2016, check that
...
** MOVE [#A] PART [[./Truncated distribution - Wikipedia, the free encyclopedia.html]]
*** quotes
    1) Definition
...
** TODO MOVE [#C] [[./usersrouted-ccs13.pdf][Users Get Routed: Traffic Correlation on Tor by Realistic Adversaries]]
*** summary
    0) [@0] ABSTRACT
...
** TODO MOVE [#B] [[/home/chive/own/tor/doc/read/tor-spec.txt][Tor Protocol Specification]]
