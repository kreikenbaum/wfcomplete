...
** MOVE [[./paper-ssl-revised.pdf][Wagner - Analysis of the SSL 3.0 protocol]]
*** summary
    0) [@0] Abstract
...
** TODO MOVE [#A] [[~/da/git/docs/onion.pdf][Anonymous Connections and Onion Routing]]
*** summary
    0) [@0] Abstract
...
** TODO [#C] MOVE PART [[./ESLII_print4.pdf][Hastie - The Elements of Statistical Learning]]
*** summary
    1) Introduction
...
*** quotes
*** ref
** TODO MOVE [#A] [[./geurtz.pdf][Extremely randomized trees]]
*** summary
    0) [@0] Abstract
...
** PART MOVE [[./Coefficient of determination - Wikipedia, the free encyclopedia.html]]
*** summary
    0) [@0] Summary
...
*** quotes
    ...
    0) [@0] Preface
       - In short, XP promises to reduce project risk, improve
         ...
         if I'm crazy.
** [[../../../chive/GG/it/LaTeX/a027.pdf][Jürgens - LATEX — Fortgeschrittene Anwendungen]]
*** quotes
...
** TODO MOVE Anonymity Loves Company
*** TODO copy summary and quotes
