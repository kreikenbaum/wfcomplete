...
*** quotes
    ...
    - (ends 4.D (=4.4))
** PART [#B] [[./random.pdf][Computer Generation of Statistical Distributions]]
*** quotes
...
*** quotes
    ...
    - (ends 3.0)
** TODO MOVE [#A] [[./tor14design.pdf][Tor: The Second-Generation Onion Router (2014 DRAFT v1)]]
*** summary
    0) [@0] Abstract
...
*** ref
    ...
    #+END_SRC
** TODO MOVE [#A] [[./oakland2012-peekaboo.pdf][Dyer - Peek-a-Boo, I Still See You: Why Efficient Traffic Analysis Countermeasures Fail]]
*** summary
    0) [@0] Abstract
...
*** ref
    ...
    #+END_SRC
** TODO [#B] [[./802163c-01_30r1.pdf][Traffic Model for 802.16 TG3 MAC/PHY Simulations]]
*** summary
    1) Introduction
...
** [[./javascript_the_good_parts.pdf][JavaScript: The Good Parts]]
*** summary
    1. Good parts
...
** [[./random - How do I generate a Poisson Process? - Stack Overflow.see_title.html]]
...
** TODO [[./HTTP Traffic Model_v1 1 white paper.pdf]]
*** summary
*** quotes
