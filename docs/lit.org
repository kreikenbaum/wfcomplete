...
** [#A] [[./4b0fa48670a7269523b1166ad302440876da.pdf][k-fingerprinting: a Robust Scalable Website Fingerprinting Technique]]
*** summary
    0) [@0] Abstract
...
*** TODO summary (weiter bei 0.4.7.Beispielcode S.262)
    0) [@0] Preface
...
*** summary
    ...
    2) CONCEPT LEARNING AND THE GENERAL-TO-SPECIFIC ORDERING
	  ...
	  1) General-to-Specific Ordering of Hypotheses
	     ...
	     - order hypotheses by moregeneral-than-or-equal-to (see quotes)
...
*** quotes
    ...
    2) CONCEPT LEARNING AND THE GENERAL-TO-SPECIFIC ORDERING
	  ...
	  - Definition: Let hj and hk be boolean-valued functions
            ...
            (written h_{j} \ge h_{k} ) if and only if
...
***** Solution
      ...
      #+END_SRC
** [#B] TODO PART 3.3 (maybe up to) [[~/da/git/docs/python-doc-reference.pdf][The Python Language Reference]]
*** summary
    1) INTRODUCTION
...
*** summary
	...
	2) Images and Tables
	   ...
	   - Images exported if no description
