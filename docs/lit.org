...
*** TODO skim chapters 2.8, 2.9, 3.3, 6.7, 7 (esp 7.10), 9, 12 and 13, 15, 16
    (leave out 11,14,17)
...
** TODO [#C] [[./guyon03a.pdf][An Introduction to Variable and Feature Selection]]
...
** TODO PART [[./pets2011-defenestrator.pdf][DefenestraTor: Throwing out Windows in Tor]]
*** TODO refactor
*** quotes
    0. [@0] unsorted
...
*** window/utils
    - getWindowLoadingContext(window)
      ...
      - Returns
        nsILoadContext
*** [[../../../chive/developer.mozilla.org/en-US/docs/MDN/Contribute/Guidelines/Style_guide.html][Writing style guide]]
**** quotes
