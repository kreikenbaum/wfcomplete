...
*** summary
    ...
    7. Conclusion
*** ref
** [[~/.webkeep/google_delayexp.pdf][Brutlag - Speed Matters for Google Web Search]]
*** summary
...
*** [[file:2016_ML1/Lecture10.pdf][Dimensionality Reduction]]
** TODO [#F] [[~/.webkeep/1801.02265..deep_wf.pdf][Sirinam - Deep Fingerprinting: Undermining Website Fingerprinting Defenses with Deep Learning]]
...
** TODO [#J] [[./10.1.1.115.3644.pdf][Müller - An Introduction to Kernel-Based Learning Algorithms]]
*** summary
    1. Introduction
       - SVMs,
...
** TODO [#L] [[~/.webkeep/BOGV92.pdf][Boser - A Training Algorithm for Optimal Margin Classifiers]]
          ...
          - [if example one style]
            #+BEGIN_SRC python
              if (this_is_one_thing and
                  ...
                  do_something()
            #+END_SRC
** TODO [#G] [[~/.webkeep/ARCHIV/DA/197.pdf][Breiman - SUBMODEL SELECTION AND EVALUATION IN REGRESSION- THE X-RANDOM CASE]]
*** summary
