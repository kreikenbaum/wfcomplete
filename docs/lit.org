...
*** summary
    ...
    6) [@7] COMPUTATIONAL LEARNING THEORY
*** quotes
    1) INTRODUCTION
       1) WELL-POSED LEARNING PROBLEMS
...
** TODO MOVE [[./DOM3-Core.pdf][Document Object Model (DOM) Level 3 Core Specification]]
...
** PART MOVE [[~/da/git/docs/onion.pdf][Anonymous Connections and Onion Routing]]
*** summary
    0) [@0] Abstract
...
** PART MOVE [[./geurtz.pdf][Extremely randomized trees]]
*** summary
    0) [@0] Abstract
...
** TODO MOVE [#C] [[./weis2006.pdf][Anonymity Loves Company: Usability and the Network Effect]]
*** quotes
...
** MOVE [#C] PART [[./Applied_Cryptography.pdf][Schneier - Applied Cryptography]]
...
** TODO PART MOVE [[./torspec/tor-spec.txt][Tor Protocol Specification]]
*** TODO refactor
...
** TODO [#C] PART [[./ESLII_print4.pdf][Hastie - The Elements of Statistical Learning]]
*** summary
    1) Introduction
...
*** TODO ref
** TODO [#C] [[./ronathan-heyning.pdf][Cheng - Traffic Analysis of SSL Encrypted Web Browsing]]
...
*** summary
    ...
    18) [@18] INTERNET DATA HANDLING
        1) [@12] base64 — RFC 3548: Base16, Base32, Base64 Data
           Encodings
...
** TODO MOVE gnuplot
*** TODO sections: spline on data points
*** summary
*** quotes
** TODO 001-process.txt: The Tor Proposal Process
*** TODO refactor
*** summary
   - form
   ...
   - status: open, accepted, finished, closed, rejected, draft,
     needs-revision, dead, needs-research, meta
   - numbers from 100 for actual proposals, meta and special 0 to 99
*** quotes
...
** TODO challenges.pdf: Challenges in deploying low-latency anonymity
*** TODO refactor
*** summary
    - intro
      TOR has grown
    - background
      - threat models and distributed trust
	- tries to maximize anonymity given some practicality and
	  usability limits
	- does not defend against global observer
    - Social challenges
...
** MOVE [[./torspec/address-spec.txt][Special Hostnames in Tor]]
*** summary
    1. Overview
