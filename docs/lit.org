...
*** TODO summary (weiter bei 0.4.7.Motivation S.254)
    0) [@0] Preface
...
** TODO [#A] [[./4b0fa48670a7269523b1166ad302440876da.pdf][k-fingerprinting: a Robust Scalable Website Fingerprinting Technique]]
*** summary
    0) [@0] Abstract
...
*** summary
    ...
    6) EXPLORING COARSE FEATURES
	  ...
	  - tuples (sum up, sum down, sum up, sum down, ...) for bursts
...
** MOVE TODO sections [#B] PART [[./user_guide_0.16.1.pdf][scikit-learn user guide]]
*** summary
...
*** summary
	...
	5) Index entries
	   ...
	   line with =#INDEX: keyword[!subkeyword]= on a line of its own
*** quotes
...
** MOVE TODO PART 3.3 (maybe up to) [[~/da/git/docs/python-doc-reference.pdf][The Python Language Reference]]
*** quotes
...
*** quotes
    - You pass a metric as metric param, and additional metric
      ...
      #+END_SRC
** MOVE TODO [[./js/javascript%20-%20Firefox%20Addon%20observer%20http-on-modify-request%20not%20working%20properly%20-%20Stack%20Overflow.html][Firefox Addon observer http-on-modify-request not working properly]]
*** quotes
    - set up
      #+BEGIN_SRC javascript
        httpRequestObserver =
...
** MOVE TODO [[./PEP 3333 -- Python Web Server Gateway Interface v1.0.1 | Python.org.html]]
*** summary
*** quotes
