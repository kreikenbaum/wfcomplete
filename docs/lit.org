...
*** quotes
    ...
    - (ends 4.D (=4.4))
** [#B] [[./random.pdf][Computer Generation of Statistical Distributions]]
*** quotes
...
*** quotes
    ...
    - use normal and log-normal distributions for the sake of
      simplicity,
    - (ends 6)
    - The likely cause of these findings is that the first few packets
      in a page often hold important features.
    - (ends 7)
    - only the remaining 60% of traffic needs to be covered by this
      defense.
    - distribution of inter-arrival times dependson the average
...
** TODO [#B] [[./morphing09.pdf][Traffic Morphing: An Efficient Defense Against Statistical Traffic Analysis]]
*** summary
    0. [@0] Abstract
