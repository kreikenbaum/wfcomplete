...
** TODO MOVE [#B] PART [[./Masterthesis.pdf][Malte Hübner - Automatische Erkennung von anormalen Android-Anwendungen]]
*** TODO ch. 2
*** summary
    2) [@2] Grundlagen
...
*** summary
    ...
    7) [@7] Pattern Recognition
       ...
       3) Optimal Margin Hyperplanes (cont. p.196)
...
**** quotes
     - grid.py is a parameter selection tool for C-SVM classification
