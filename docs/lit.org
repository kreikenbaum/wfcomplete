#+PRIORITIES: A E E
#+TODO: DOC PART TODO | META DONE
[[./master.bib]]
* asdf
** META [[~/chive/locallit.org]]
...
** TODO [#B] (ch5+7) [[./McGrawHill_-_Machine_Learning_-Tom_Mitchell.pdf][Mitchell - Machine Learning]]                         :ML:
...
*** snippets
    0. [@0] Summary
       - (auch auf deutsch)
** TODO PART [#C] [[./thebook.pdf][Smola - INTRODUCTION TO MACHINE LEARNING]]               :ML:
...
** TODO [#D] [[./user_guide_0.16.1.pdf][Pedregosa - scikit-learn user guide]] [0/3]
...
** TODO [#E] PART [[/usr/share/doc/texlive-doc/generic/pgf/pgfmanual.pdf][Tantau - The TikZ and PGF Packages]]
...
** PART [#A] [[./torspec/pt-spec.txt][Pluggable Transport Specification (Version 1)]]
...
** PART Chang - LIBSVM: a library for support vector machines
...
** [[~web/keep/Thesis Writing-A Guide.pdf][Gruen - Thesis Writing]]
