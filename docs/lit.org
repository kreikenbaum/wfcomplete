...
** MOVE [[./challenges.pdf][Dingledine - Challenges in deploying low-latency anonymity]]
*** summary
    0. [@0] Abstract
...
** TODO [#A] [[./1410.2087v3.pdf][Fegghi - A Web Traffic Analysis Attack Using Only Timing Information]]
*** expansion of [[*%5B%5B./ieee-icc15.pdf%5D%5BFeghhi%20-%20A%20First-Hop%20Traffic%20Analysis%20Attack%20Against%20Tor%5D%5D][Feghhi - A First-Hop Traffic Analysis Attack Against Tor*]]
    join both
*** ref [[file:master.bib::DBLP:journals/tifs/FeghhiL16][Feghhi & Leith 2016: Web Traffic Analysis]]
** TODO [#A] [[./wright-passive.pdf][Defending Anonymous Communications Against Passive Logging Attacks]]
...
** TODO [#B] [[./wurster-nspw-08.pdf][The Developer is the Enemy]]
...
** PART [[./pets2011-defenestrator.pdf][DefenestraTor: Throwing out Windows in Tor]]
*** TODO refactor
*** quotes
    0. [@0] unsorted
...
*** summary
    - [[file:///usr/share/doc/python-matplotlib-doc/html/api/pyplot_api.html][plot]]
      - with one data array, setting color from color_cycle, and transparency
        ...
        #+END_SRC
*** quotes
** PART MOVE [[../../../chive/GG/it/LaTeX/Symbols/symbols.pdf][Carlisle - The Great, Big List of \LaTeX Symbols]]
*** quotes
    14) [@14] Delimiters
        - \langle =\ langle=
        - \rangle =\ rangle=
