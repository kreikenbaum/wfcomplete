...
** TODO MOVE [[./crov1297.pdf][Long-Lasting Transient Conditions in Simulations with Heavy-Tailed Workloads]]
...
** PART MOVE [[./Google JavaScript Style Guide.html][Google JavaScript Style Guide]]
*** summary
...
** td: ways to access loading of pages
** TODO MOVE [[/home/chive/import/pakdoc/][Hypertext Transfer Protocol -- HTTP/1.0]]
*** summary
*** quotes
*** ref: [[file:master.bib::rfc1945][Berners-Lee et al. 1996: Hypertext Transfer Protocol]]
** MOVE [[./Intercepting Page Loads - Mozilla | MDN.html][Intercepting Page Loads]]
*** summary
...
** TODO MOVE [[./Getting Started - Ajax | MDN.html]]
** TODO MOVE [[./XMLHttpRequest - Web API Referenz | MDN.6limit.html]]
