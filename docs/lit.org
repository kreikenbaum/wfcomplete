...
** TODO [#A] [[./hastie.pdf][Hastie - The Elements of Statistical Learning]]               :ML:
*** TODO [#A] kloft: (Section *12.2*)
...
** TODO [#C] [[~web/keep/thesis/Bishop - Pattern Recognition And Machine Learning - Springer  2006.pdf][Bishop - Pattern Recognition and Machine Learning]] [0/1]
*** TODO [#C] skim
...
** TODO [#C] [[~web/keep/thesis/Geman92.pdf][Geman - Neural networks and the bias/variance dilemma]] [0/1]
*** TODO [#C] skim
...
** TODO [#C] [[./numprint.pdf][The numprint package]] [0/1]
...
** TODO [#C] [[./traffic.pdf][Traffic Analysis Attacks and Trade-Offs in Anonymity Providing Systems]]
*** summary
*** quotes
...
** TODO [#D] [[./SS03.pdf][Passive Attack Analysis for Connection-Based Anonymity Systems]]
*** summary
*** quotes
*** ref [[file:master.bib::SS03][Serjantov & Sewell 2003: Passive Attack Analysis]]
** TODO [#D] [[/usr/share/doc/python-sklearn-doc/stable/index.html][Pedregosa - scikit-learn user guide]] [0/5]
...
** TODO [#D] [[./10.1.1.60.7300.measureanon.pdf][Towards measuring anonymity]]
*** summary
*** quotes
*** ref [[file:master.bib::Diaz02towardsmeasuring][Diaz et al. 2002: Towards Measuring Anonymity]]
** TODO [#D] [[./Vorratsdatenspeicherung – Wikipedia.html][Wikipedia - Vorratsdatenspeicherung]]
*** summary
    0. [@0]
...
** TODO [[~/da/git/sw/LLaMA/README.md][Cherubin - LLaMA, A Tor Browser add-on to hamper website fingerprinting]]
*** quotes
