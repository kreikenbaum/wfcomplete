...
*** summary
    ...
    7) Conclusion
** TODO [[./wtfpad-setup.pdf][Arp - Setup der Obfuscation-Tools]]
*** summary
*** quotes
...
** TODO [#B] PART [[./Applied_Cryptography.pdf][Applied Cryptography]]
*** summary
    1) Foundations
...
** TODO [#B] PART [[./DOM3-Core.pdf][Document Object Model (DOM) Level 3 Core Specification]]
...
** TODO [#B] [[./10.1.1.20.2080.bloom_orig.pdf][Space/Time Trade-offs in Hash Coding with Allowable Errors]]
*** summary
    0) [@0] Abstract
...
** PART [[./user_guide_0.16.1.pdf][scikit-learn user guide]]
*** summary
...
***** Solution
      ...
      #+END_SRC
** PART [[./random.pdf][Computer Generation of Statistical Distributions]]
*** summary
    1) SUMMARY
...
** PART [[./ESLII_print4.pdf][The Elements of Statistical Learning]]
*** summary
    1) Introduction
...
** PART  [[./irbookonlinereading.pdf][An Introduction to Information Retrieval]]
*** summary
    0. [@0] Preface
...
*** quotes
  ...
  14. [@14] Vector space classification
	  ...
	  and noisy data sets.
*** TODO ref
** PART [[~/da/git/docs/python-doc-reference.pdf][The Python Language Reference]]
*** summary
    1) INTRODUCTION
