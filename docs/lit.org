...
** TODO MOVE [[./ccs14.pdf][Cai 2014 - A Systematic Approach to Developing and Evaluating Website Fingerprinting Defenses]]
*** TODO order quotes
*** summary
    0) [@0] ABSTRACT
...
** TODO MOVE [#B] PART [[./hastie.pdf][Hastie - The Elements of Statistical Learning]]     :ML:
...
** TODO MOVE [#C] PART [[../../../chive/GG/it/emacs/org.pdf][Dominik - The Org Manual]]
*** TODO [#C] views (for priority a items in da.org (and lit.org))
*** summary
    1) Introduction
...
** TODO MOVE [#A] PART [[./user_guide_0.16.1.pdf][Pedregosa - scikit-learn user guide]]
*** TODO [#A] see [[file:~/da/da.org::*open%20world][open world]]
        - 11.18.4 Receiver Operating Characteristic (ROC) with cross validation
        - 11.18.8 Receiver Operating Characteristic (ROC)
        - 42.21. sklearn.metrics: Metrics: sklearn.metrics.auc
...
** TODO MOVE [#C] [[./torspec/proposals/ideas/xxx-using-spdy.txt][Murdoch - Using the SPDY protocol to improve Tor performance]]
