...
** TODO [#B] [[./geurtz.pdf][Extremely randomized trees]]
*** summary
    0) [@0] Abstract
...
*** TODO ref
** TODO MOVE [#A] [[./ronathan-heyning.pdf][Cheng - Traffic Analysis of SSL Encrypted Web Browsing]]
*** summary
*** quotes
...
** TODO [#B] [[./Liberatore_2006.pdf][Inferring the Source of Encrypted HTTP Connections]]
*** ref
...
*** quotes
    ...
    - You should try to use as few except clauses in your code as you
      can
** TODO MOVE [#C] [[./python-doc-tutorial.pdf][Python Tutorial]]
*** summary
    0) [@0]
    ...
    1) gnuplot
       ...
       2) [@2] Introduction
          ...
          - document syntax:
            ...
            - <> replacesable tokens (have default value if omitted)
...
** PART MOVE [[./rfc2068.txt][RFC 2068 - Hypertext Transfer Protocol -- HTTP/1.1]]
*** summary
    19) [@19] Appendices
...
** PART MOVE [[./rfc7230.pdf][RFC 7230 - Hypertext Transfer Protocol (HTTP/1.1): Message Syntax and Routing]]
*** summary
*** quotes
...
*** summary
    ...
    3) Economics of Software Development
       ...
       You can abandon, switch, defer or grow. There are interest payments.
...
** TODO MOVE [[./torspec/proposals/001-process.txt][Mathewson - The Tor Proposal Process]]
...
*** summary
    0) Scope and preliminaries
     ...
     1) ...
*** quotes
** MOVE Crockford on JavaScript - Section 8 Programming Style _ Your Brain.flv
*** quotes
