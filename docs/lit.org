...
*** quotes
    ...
    - numpy.array(object, dtype=None, copy=True, order=None,
      ...
      Create an array.
** TODO [[./tor14design.pdf][Tor: The Second-Generation Onion Router (2014 DRAFT v1)]]
*** summary
    0) [@0] Abstract
...
** ~/da/git/docs/onion-discex00.pdf
   see also bibtex
** ~/da/git/docs/onion.pdf
** ~/da/git/docs/onion-routing_ih96.pdf
** ~/da/git/docs/onion-routing_pet2000.ps
** ~/da/git/docs/timing-fc2004.pdf
** ~/da/git/docs/10.1.1.96.7225.pdf
** ~/da/git/docs/TR_DCC-1999-005.pdf
** ~/da/git/docs/mlj12.pdf
** ~/da/git/docs/0306-SMCSIA-FGBZ.pdf
