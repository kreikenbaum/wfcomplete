...
*** quotes
    6) Other
       - Note: As setTimeout takes a function object as its first
         ...
         any error.
** [#A] [[./webfingerprint-wpes.pdf][Improved Website Fingerprinting on Tor]]
*** summary
    0) [@0] Abstract
...
** [#A] [[./4b0fa48670a7269523b1166ad302440876da.pdf][Danezis - k-fingerprinting: a Robust Scalable Website Fingerprinting Technique]]
*** summary
    0) [@0] Abstract
...
** [#B] [[./ShWa-Timing06.pdf][Timing analysis in low-latency mix networks: attacks and defenses]]
*** summary
    0) [@0] Abstract
...
** [#B] [[./oakland2012-peekaboo.pdf][Dyer - Peek-a-Boo, I Still See You: Why Efficient Traffic Analysis Countermeasures Fail]]
*** summary
    0) [@0] Abstract
...
*** quotes
    ...
    6) [@7] BuFLO: BUFFERED FIXED -LENGTH OBFUSCATOR
       - whether any measure can work, even prohibitively inefficient
         ones.
*** ref [[file:~/da/docs/master.bib::oakland2012-peekaboo][Dyer et al. 2012: Peek Boo I]]
** [#B] [[./critique.html][A Critique of Website Traffic Fingerprinting Attacks]]
*** summary
...
*** summary
    ...
    6) A NOVEL WEBSITE FINGERPRINTING ATTACK
       ...
       - sequences: c = 2^11 , ... , 2^17 and γ = 2^−3 , ... , 2^3 ,
...
** [[./Add-ons_Extension Signing - MozillaWiki.html]]
*** summary
...
** [[./Tor Project: Pluggable Transports.html][Tor: Pluggable Transports]]
*** summary
...
*** quotes
*** [[file:master.bib::tor-pt][Tor 2016: Pluggable Transports]]
** [[./Tor Project: obfsproxy.html][Tor Project: obfsproxy]]
*** summary
...
*** TODO summary (weiter bei Besucher.Struktur+Teilnehmer, S. 304)
    0) [@0] Preface
...
*** TODO ref
    - german with note?
** TODO [#A] PART -s 1,5,7 [[./McGrawHill_-_Machine_Learning_-Tom_Mitchell.pdf]]
*** summary
    1) INTRODUCTION
    ...
    5) [@5] EVALUATING HYPOTHESES
	  ...
	  1) Sample Error and True Error
	     ...
	     - Definition: The *true error* (denoted error_{D}(h)) of
	       ...
	       error_{S}(h) \equiv Pr_{x \in D}[f(x) \neq h(x)]
	  2) Confidence Intervals for Discrete-Valued Hypotheses
	     - [confidence interval z_N = 1.96 for 95% confidence interval]
               error_{S} \pm z_{N} \sqrt(error_{S}(h)(1- error_{S}(h))/n) (5.1)
	     - n \cdot error_{S}(h) (1-error_{S}(h)) \ge 5
*** ref [[file:master.bib::mitchell][Mitchell: Machine Learning]]
** TODO [#A] [[./usersrouted-ccs13.pdf][Users Get Routed: Traffic Correlation on Tor by Realistic Adversaries]]
*** summary
    0) [@0] ABSTRACT
...
*** ref: [[file:~/da/docs/master.bib::ccs2013-usersrouted][Johnson et al. 2013: Users Get Routed]]
** MOVE [#A] [[./wfpadtools-spec.txt][WFPadTools Protocol Specification]]
*** summary
...
** TODO [#B] [[./torspec/tor-spec.txt][Tor Protocol Specification]]
*** [#B] 0.3 to 3 (see also spacing), see that correct
*** summary
    0) [@0] Preliminaries:
...
*** TODO [#A] ref [[file:master.bib::tor-spec][Dingledine & Mathewson 2014: Tor Protocol Specification]]
    better exact version
** TODO sections [#B] PART [[./user_guide_0.16.1.pdf][scikit-learn user guide]]
*** summary
...
***** Solution
      ...
      #+END_SRC
** TODO [#B] [[./Oya.pdf][Do dummies pay off ? Limits of dummy traffic protection in anonymous communications]]
*** summary
    0) [@0] Abstract
...
** TODO [#B] [[./10.1.1.20.98.bloom-nw.pdf][Network Applications of Bloom Filters: A Survey]]
*** summary
*** quotes
...
*** TODO ref
** TODO [#C] [[./ronathan-heyning.pdf][Traffic Analysis of SSL Encrypted Web Browsing]]
...
** TODO [#C] [[./10.1.1.20.2080.bloom_orig.pdf][Space/Time Trade-offs in Hash Coding with Allowable Errors]]
*** summary
*** quotes
...
*** quotes
    5) [@5] PROBABILITY DISTRIBUTION FUNCTIONS
	  ...
	  2) [@2] Binomial
	     ...
	     - Notes:
	       3. For large n, the binomial can be approximated by
...
** [#A] PART [[./Truncated distribution - Wikipedia, the free encyclopedia.html]]
*** quotes
    1) Definition
...
*** quotes
    ...
    - (ends 2.6.0)
    - (ends 18.1)
** TODO sections maybe eval PART [#B] [[./thebook.pdf][INTRODUCTION TO MACHINE LEARNING]] [0/2]
*** TODO summary
    1) Introduction
...
** PART [#B] [[./irbookonlinereading.pdf][An Introduction to Information Retrieval]]
*** summary
    0. [@0] Preface
...
*** quotes
  ...
  14. [@14] Vector space classification
	  ...
	  and noisy data sets.
*** TODO ref
** [#B] PART [[~/da/git/docs/python-doc-reference.pdf][The Python Language Reference]]
*** summary
    1) INTRODUCTION
...
** PART [#C] [[./Split or filter your PCAP files with SplitCap - NETRESEC Blog.htm]]
*** summary
...
** [#B] PART [[file:///home/chive/IT-gg/js/Eloquent%20JavaScript/contents.html][Eloquent Javascript]]
*** summary
...
*** quotes
    3) [@3] The Entries
	  ...
	  3) *mastersthesis* A Master’s thesis. Required fields:
             author, title, school, year. Optional fields: type,
             address, month, note.
	  4) *techreport* A report published by a school or other
	  ...
	  5) *unpublished* A document having an author and title, but
...
*** summary
	...
	4) Include files
	   ...
	   - can also have =:minlevel n= to adjust levels to that and
...
** (for picture): [[./10_3-ndss2016-slides.pdf][Website Fingerprinting at Internet Scale Presentation]]
...
** [[./tarzan:ccs02.pdf][Tarzan: A Peer-to-Peer Anonymizing Network Layer]]
*** summary
*** quotes
...
** PART MOVE [[./doc_meek – Tor Bug Tracker & Wiki.choose_pluggable_transport.html][doc/meek – Tor Bug Tracker & Wiki]]
*** summary
    0) [@0]
...
*** quotes
    ...
    - ClientTransportPlugin transport socks4|socks5 IP:PORT
      ...
      [...] In its second form, when set along with a corresponding
      Bridge line, the Tor client launches the pluggable transport
      proxy executable in path-to-binary using options as its
      command-line options, and forwards its traffic to it. It’s the
      duty of that proxy to properly forward the traffic to the
      bridge.
...
** TODO [#B] search feature vs classifier MOVE [[./2009-diss.pdf][Machine Learning for Application-Layer Intrusion Detection]]
*** #B PART
*** summary
    1) Introduction
...
** TODO MOVE [#A] [[./torspec/pt-spec.txt][Pluggable Transport Specification (Version 1)]]
*** TODO #A at least part
*** summary
    0) [@0] Abstract
