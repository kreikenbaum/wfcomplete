...
** TODO MOVE [#A] [[./LiuSIGIR2010.pdf][Liu - Understanding web browsing behaviors through Weibull analysis of dwell time]]
...
** TODO MOVE [#A] [[./ton96.pdf][Crovella - Self-Similarity in World Wide Web Traffic: Evidence and Possible Causes]]
...
** TODO MOVE [#A] [[./p434.pdf][Casalicchio - A client-aware dispatching algorithm for web clusters providing multiple services]]
*** TODO [#A] (was C) skim for [[file:~/da/git/diplomarbeit.org::#HTTP%20traffic%20model][HTTP traffic model]]
*** ref
