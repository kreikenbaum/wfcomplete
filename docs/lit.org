...
** [[../sw/p/classifier/README.txt][Pancheko - classifier/README.txt]]
*** summary
...
** TODO [#A] vorlesungsnotizen sv2/3 zu stufen der mustererkennung :hannover_laptop:
   [2016-09-07 Mi]
   [[file:~/da/git/diplomarbeit.org::*preprocessing][preprocessing]]
** TODO MOVE [#B] [[./wright-passive.pdf][Defending Anonymous Communications Against Passive Logging Attacks]]
*** summary
    0) [@0] Abstract
...
** TODO [#A] PART [[./Masterthesis.pdf][Malte Hübner - Automatische Erkennung von anormalen Android-Anwendungen]]
*** TODO ch. 2
*** summary
    2) [@2] Grundlagen
...
** TODO PART [#B] [[./thebook.pdf][Smola - INTRODUCTION TO MACHINE LEARNING]] [0/2]
...
** TODO MOVE [#C] [[./browser.html][The Design and Implementation of the Tor Browser]]
*** summary
    1) Introduction
...
** TODO [#B] PART [[./hastie.pdf][Hastie - The Elements of Statistical Learning]]
...
*** quotes
    ...
    2) [@2] Overview of Supervised Learning
       ...
       8) [@8] Classes of Restricted Estimators
          ...
          3) Basis Functions and Dictionary Methods
             - Radial basis functions have centroids μ m and scales λ
               m that have to be determined. The spline basis
    ...
    10) Boosting and Additive Trees
        7) [@7] “Off-the-Shelf” Procedures for Data Mining
           - They are relatively *fast to construct* and they produce
             *interpretable models* (if the trees are small). As
             discussed in Section 9.2, they naturally incorporate
             mixtures of numeric and categorical predictor variables
             and missing values. They are invariant under (strictly
             monotone) transformations of the individual
...
** TODO MOVE [#C] [[./LZCLCP_NDSS11.pdf][Luo - HTTPOS: Sealing Information Leaks with Browser-side Obfuscation of Encrypted Flows]]
*** summary
    0) [@0] Abstract
...
** TODO MOVE [#C] [[./cacr2015-09.pdf][Wang - On Realistically Attacking Tor with Website Fingerprinting]]
*** summary
    0) [@0] Abstract
...
** TODO MOVE [#C] [[~/da/git/docs/timing-fc2004.pdf][Timing Attacks in Low-Latency Mix Systems]]
** TODO MOVE [#C] PART [[./Curose-Ross - Computer_Networking_-_A_Top-down_Approach_Featuring_the_Internet__Third_Edition.pdf][Kurose - Computer Networking: A Top-Down Approach Featuring the Internet]]
*** TODO http
*** summary (up to p.103)
...
** TODO MOVE [[./Matplotlib.pdf][Hunter - Matplotlib]]
*** summary
...
** TODO MOVE [#B] [[./oakland2013-parrot.pdf][The Parrot is Dead: Observing Unobservable Network Communications]]
*** summary
    0) [@0] Abstract
...
** TODO MOVE [[./python-doc-tutorial.pdf][Python Tutorial]]
   :PROPERTIES:
    ...
    9) [@9] CLASSES
       2) [@2] Python Scopes and Namespaces
          - Class definitions play some neat tricks with namespaces, and you
            ...
            what’s going on.
** TODO MOVE [#B] [[~/da/git/docs/onion.pdf][Anonymous Connections and Onion Routing]]
*** summary
    0) [@0] Abstract
...
** TODO MOVE [#B] [[./guyon03a.pdf][An Introduction to Variable and Feature Selection]]
...
*** quotes
    ...
    - navigate(url)
      ...
      navigate to.
** TODO MOVE [#C] [[./python-doc-howto-doanddont.pdf][Idioms and Anti-Idioms in Python]]
*** summary
...
** TODO MOVE [#C] [[./ton96.pdf][Self-Similarity in World Wide Web Traffic: Evidence and Possible Causes]]
*** summary
*** quotes
...
** PART MOVE [[file:Curse%20of%20dimensionality%20-%20Wikipedia,%20the%20free%20encyclopedia.html][file:~/da/git/docs/Curse of dimensionality - Wikipedia, the free encyclopedia.html]]
          ...
          4) [@4] Support Vector Machines
             5) [@5] Tips on Practical Use
                - Avoiding data copy: For SVC, SVR, NuSVC and NuSVR,
                  if the data passed to certain methods is not
                  C-ordered contiguous, and double precision, it will
                  be copied before calling the underlying C
                  implementation. You can check whether a give numpy
                  array is C-contiguous by inspecting its =flags=
                  attribute.
...
***** Solution
      ...
      #+END_SRC
** PART [[./2009-diss.pdf][Rieck - Machine Learning for Application-Layer Intrusion Detection]]
*** summary
    0) [@0] Acknowlegements
...
*** quotes
    ...
    28) PYTHON RUNTIME SERVICES
        ...
        12) [@12] xgc — Garbage Collector interface
...
** PART Beck - extreme Programming explained
*** summary
...
** [[./numprint.pdf][The numprint package]]
*** summary
    3) [@3] Customization
...
** [[./webtiming.pdf][Felten - Timing Attacks on Web Privacy]]
*** ref [[file:master.bib::DBLP:conf/ccs/FeltenS00][Felten & Schneider 2000: Timing Web]]
** [[./voydock.pdf][Voydock - Security Mechanisms in High-Level Network Protocols]]
*** ref
...
** [[./Newman etal2003.pdf][Newman - Metrics for Traffic Analysis Prevention]]
