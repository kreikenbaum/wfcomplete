...
*** summary
    ...
    7) Conclusion
** PART MOVE [[./wtfpad-setup.pdf][Arp - Setup der Obfuscation-Tools]]
*** summary
*** quotes
...
*** TODO summary (weiter bei Besucher, S. 317)
    0) [@0] Preface
...
** TODO [#A] PART -s 1,5,7 [[./McGrawHill_-_Machine_Learning_-Tom_Mitchell.pdf][Mitchell - Machine Learning]]
*** summary
    1) INTRODUCTION
...
** TODO [#A] [[./usersrouted-ccs13.pdf][Johnson - Users Get Routed: Traffic Correlation on Tor by Realistic Adversaries]]
*** summary
    0) [@0] ABSTRACT
...
** PART MOVE [[./torspec/pt-spec.txt][Pluggable Transport Specification (Version 1)]]
...
** TODO [#A] PART (for picture): [[./10_3-ndss2016-slides.pdf][Website Fingerprinting at Internet Scale Presentation]]
...
** PART MOVE [[./user_guide_0.16.1.pdf][scikit-learn user guide]]
*** summary
...
** TODO [#B] PART [[./Curose-Ross - Computer_Networking_-_A_Top-down_Approach_Featuring_the_Internet__Third_Edition.pdf]]
*** summary (up to p.103)
...
** TODO MOVE [#B] PART [[./Applied_Cryptography.pdf][Applied Cryptography]]
*** summary
    1) Foundations
	  ...
	  - cryptology is cryptography for writing and crypanalysis for
            checking if secure

	  - Authentication, Integrity, and Nonrepudiation: additional
            to confidentiality: as in face-to-face communication
...
*** quotes
    3) [@3] The Entries
	  ...
	  3) *manual* Technical documentation. Required field:
             title. Optional fields: author, organization, address,
             edition, month, year, note.
	  4) *mastersthesis* A Master’s thesis. Required fields:
             author, title, school, year. Optional fields: type,
             address, month, note.
	  5) *techreport* A report published by a school or other
	  ...
	  6) *unpublished* A document having an author and title, but
...
** PART [[/home/chive/IT-gg/js/Ecma-262.pdf][ECMAScript Language Specification]]
*** summary
...
*** quotes
*** ref
** TODO MOVE [#A] PART [[./DOM3-Core.pdf][Document Object Model (DOM) Level 3 Core Specification]]
