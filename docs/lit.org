...
** TODO [#A] [[./browser.html][The Design and Implementation of the Tor Browser]]
*** summary
    1) Introduction
...
*** ref url: https://www.torproject.org/projects/torbrowser/design/#proxy-obedience
** PART MOVE [[./pets2011-defenestrator.pdf][DefenestraTor: Throwing out Windows in Tor]]
*** TODO refactor
*** quotes
    0. [@0] unsorted
...
** TODO [#A] [[./TAIntro-book.pdf][Danezis - Introducing Traffic Analysis]]
*** summary
    1) Introduction
...
** TODO [#B] [[./csbuflo.pdf][Cai - CS-BuFLO: A Congestion Sensitive Website Fingerprinting Defense]]
*** summary
    0) [@0] Abstract:
...
** TODO PART [#C] [[./thebook.pdf][Smola - INTRODUCTION TO MACHINE LEARNING]] [0/2]
...
*** summary
    - Should I normalize/standardize/rescale the data?
      ...
      - *rescale*: add/subtrace, then divide/multiply, example: Celsius
        to Fahrenheit

      - *normalize*: divide by norm of vector: make length 0
...
*** summary
    - [[file:///usr/share/doc/python-matplotlib-doc/html/api/pyplot_api.html][plot]]
      - with one data array, setting color from color_cycle, and transparency
        ...
        #+END_SRC
*** quotes
** PART [[../../../chive/GG/it/LaTeX/Symbols/symbols.pdf][The Great, Big List of \LaTeX Symbols]]
*** quotes
    14) [@14] Delimiters
        - \langle =\ langle=
        - \rangle =\ rangle=
...
** TODO MOVE [#A] [[./1410.2087v3.pdf][A Web Traffic Analysis Attack Using Only Timing Information]]
*** check if differences with [[*%5B%5B./ieee-icc15.pdf%5D%5BFeghhi%20-%20A%20First-Hop%20Traffic%20Analysis%20Attack%20Against%20Tor%5D%5D][Feghhi - A First-Hop Traffic Analysis Attack Against Tor*]]
    if none, join both, else check
*** ref [[file:master.bib::DBLP:journals/tifs/FeghhiL16][Feghhi & Leith 2016: Web Traffic Analysis]]
** [[./comp.ai.neural-nets FAQ, Part 3 of 7 GeneralizationSection What are cross-validation and bootstrapping.html][comp.ai.neural-nets FAQ, Part 3 of 7: Generalization Section - What are cross-validation and bootstrapping?]]
** TODO [[./guyon03a.pdf][An Introduction to Variable and Feature Selection]]
** TODO [[./move-ndss.pdf][M O V E: An End-to-End Solution To Network Denial of Service]]
** TODO MOVE [#A] [[./wright-passive.pdf][Defending Anonymous Communications Against Passive Logging Attacks]]
** TODO MOVE [#B] [[./wurster-nspw-08.pdf][The Developer is the Enemy]]
