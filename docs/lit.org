...
*** TODO summary (weiter bei Implementierung.3. S. 281)
    0) [@0] Preface
...
** MOVE [#B] [[./oakland2012-peekaboo.pdf][Dyer - Peek-a-Boo, I Still See You: Why Efficient Traffic Analysis Countermeasures Fail]]
*** summary
    0) [@0] Abstract
...
** MOVE [#B] [[./critique.html][A Critique of Website Traffic Fingerprinting Attacks]]
*** summary
...
***** Solution
      ...
      #+END_SRC
** MOVE [#B] PART [[~/da/git/docs/python-doc-reference.pdf][The Python Language Reference]]
*** summary
    1) INTRODUCTION
...
** TODO [#A] [[./wfpadtools-spec.txt][WFPadTools Protocol Specification]]
*** summary
...
** TODO MOVE [#A] [[./usersrouted-ccs13.pdf][Users Get Routed: Traffic Correlation on Tor by Realistic Adversaries]]
*** summary
    0) [@0] ABSTRACT
...
** [#C] TODO [[./PEP 3333 -- Python Web Server Gateway Interface v1.0.1 | Python.org.html]]
*** summary
*** quotes
...
** TODO MOVE [#C] [[./ronathan-heyning.pdf][Traffic Analysis of SSL Encrypted Web Browsing]]
...
** MOVE TODO [#C] [[./crov1297.pdf][Long-Lasting Transient Conditions in Simulations with Heavy-Tailed Workloads]]
*** summary
    0) [@0] ABSTRACT
...
** TODO MOVE [[./top_ml_algo.pdf][Top 10 algorithms in data mining]]
...
** TODO [#C] MOVE [[./10.1.1.20.2080.bloom_orig.pdf][Space/Time Trade-offs in Hash Coding with Allowable Errors]]
*** summary
*** quotes
*** ref [[file:master.bib::Bloom70space/timetrade-offs][Bloom 1970: Space Time Trade]]
** TODO [#B] MOVE [[./10.1.1.20.98.bloom-nw.pdf][Network Applications of Bloom Filters: A Survey]]
*** summary
*** quotes
...
** TODO MOVE [[./esa2006b.pdf][An Improved Construction for Counting Bloom Filters]]
** MOVE [[./Add-ons_Extension Signing - MozillaWiki.html]]
*** summary
...
** MOVE [[./Tor Project: Pluggable Transports.html][Tor: Pluggable Transports]]
*** summary
...
*** quotes
*** ref: see .url
** MOVE [[./Tor Project: obfsproxy.html]]
*** summary
