...
* TODO Results and Evaluation [24%]
** WRITE Setup
*** EVA sites
...
*** WRITE classification
    ...
    - hastie on parameter estimation live vs meta
...
*** MOVE integrate to [[#different-classifiers][panchenko v1 different classifiers]] KEYWORDS (for [[file:~/da/da.org::*klassifikation][klassifikation {0/12}]]) svc vs extratrees
