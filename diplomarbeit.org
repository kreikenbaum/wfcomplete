...
*** Feature Extraction
    ...
    approximation \citep{wpes13-fingerprinting} is the size of each
    TLS \citep{rfc5246} record. Alternatives are sizes TCP
    \citep{rfc793} or IP \citep{rfc791} packets. As of
    \citet{wpes13-fingerprinting}, these work almost as well.
