...
** EVA-AGAIN Website Fingerprinting
   :PROPERTIES:
   :CUSTOM_ID: wf
   :END:
   #+INDEX: attack
...
*** EVA Website Fingerprinting 2.0
    :PROPERTIES:
    :CUSTOM_ID: wf2.0
    :END:
...
experience /E/.
     ...
     /Merkmalsextraktion/ (feature extraction).] The first
     ...
     for f.ex. the number of outgoing packets. The third groups these
...
***** EVA Choice: How to Set Cover Traffic Target Values
      #+INDEX: I
      #+INDEX: flavour!I
      #+INDEX: II
      #+INDEX: flavour!II
...
**** CHECK Why as an add-on
     ...
     and whistles, defending at the application layer solves this
     deanonymization problem where its origins are[fn::see also
     section [[#design-whyhttp][Why HTTP-shaped Cover Traffic]]].

     Thus, not everyone needs website fingerprinting defenses, and the
...
** WRITE Website Fingerprinting [1/6]
   :PROPERTIES:
   :CUSTOM_ID: eval-wf
   :END:
