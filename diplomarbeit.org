...
stochastic defenses. Most other defenses used non--subexponential
...
function models the number of embedded objects. This model provides
the cover traffic target sizes. It also sets the page's actual sizes,
...
was initialized once to fixed page sizes for the top
pages. Dynamically updating the filter might solve problem /1/ and
further help with problem /3/ (future work).
...
** Setup
- how is stuff evaluated
- how is the physical setup
- how to reproduce
...
- how was data analysed
          ...
          - circuit resetting, no caches, time gaps (TODO: effective)
...
** Analysing defenseless results
   ...
   - code
   - table
                      C       _id  auc_bound     auroc  background_size    binary       fpr     gamma  scenario.date     score       tpr    lenexc
C              1.000000  0.118955        NaN -0.889391     -0.051873    -0.149428 -0.223558 -0.181484     -0.378735   0.028769 -0.289110 -0.201612
_id            0.118955  1.000000        NaN  0.999492      0.320409     0.057859 -0.210395  0.064541      0.336638  -0.354099 -0.360886  0.464923
auc_bound           NaN       NaN        NaN       NaN           NaN          NaN       NaN       NaN           NaN        NaN       NaN       NaN
auroc         -0.889391  0.999492        NaN  1.000000      0.839753          NaN  0.989973 -0.994292      0.999917  -0.999222 -0.997396  0.660672
background... -0.051873  0.320409        NaN  0.839753      1.000000     0.431240 -0.838036  0.349276      0.053204   0.133098 -0.635416  0.593175
binary        -0.149428  0.057859        NaN       NaN      0.431240     1.000000 -0.196755 -0.228546     -0.205184  -0.032467 -0.392767  0.484946
fpr           -0.223558 -0.210395        NaN  0.989973     -0.838036    -0.196755  1.000000 -0.389393      0.266762  -0.338756  0.519529 -0.411778
gamma         -0.181484  0.064541        NaN -0.994292      0.349276    -0.228546 -0.389393  1.000000      0.083364   0.411823  0.195362  0.350942
scenario.date -0.378735  0.336638        NaN  0.999917      0.053204    -0.205184  0.266762  0.083364      1.000000  -0.352831 -0.148659  0.096254
score          0.028769 -0.354099        NaN -0.999222      0.133098    -0.032467 -0.338756  0.411823     -0.352831   1.000000  0.325567  0.212428
tpr           -0.289110 -0.360886        NaN -0.997396     -0.635416    -0.392767  0.519529  0.195362     -0.148659   0.325567  1.000000 -0.176195
lenexc        -0.201612  0.464923        NaN  0.660672      0.593175     0.484946 -0.411778  0.350942      0.096254   0.212428 -0.176195  1.000000
    - next listitem
