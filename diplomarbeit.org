...
** PENDING (llama-delay-100) Closed World
   :PROPERTIES:
   ...
   # code: see [[file:bin/results.py::#%20result%20with%20closest%20size%20overhead]]
...
*** TODO accuracy/overhead figure for 100 sites
...
*** WRITE Low Accuracy on my Captures
    ...
    - case study: capture at 2017-10-16 is broken
      ...
      - [[./pictures/confmat-2017-10-16.png]]
** KEYWORDS Open World
   :PROPERTIES:
   :CUSTOM_ID: sub4-open
   :END:
