...
#+END_LaTeX
    ...
    transforming HTTP/1.x to this at the exit node
    \cite{tor-spec-spdy}.
...
* WRITE Results and Evaluation [50%]
** DANIEL Introduction
...
*** WAIT Which Features Help Most in Classification
    ...
    - graph
      ...
      - caption: first four are
        ...
        - inSize
      - like esl ch.15
**** WAIT for [[file:~/da/da.org::*features%20relevancy%20graphics][features relevancy graphics]]
...
*** KEYWORDS (maybe) vs Optimal Attacker
    ...
    - \cite{a-systematic} does not help, as it deals with a
      ...
      - and?  [[file:~/da/da.org::*experimente][experimente]].(capture just...)
*** WRITE Websites
    :PROPERTIES:
    :CUSTOM_ID: websites
    :END:
