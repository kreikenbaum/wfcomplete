...
*** WAIT Hurdles to Website Fingerprinting: HTTP Protocol Evolution
    :PROPERTIES:
    :CUSTOM_ID: Hurdles
    :END:
...
#+END_LaTeX
    ...
    without.
      ...
      - *hope that spdy makes it harder again*
        - ref mike perry
**** WAIT for [[file:~/da/da.org::*download%20doc][download doc]]
...
*** CHECK k-fingerprinting
    ...
    leafs constitute a "fingerprint". A testing trace's fingerprint is
    then compared via kNN to the training fingerprints. If the nearest
