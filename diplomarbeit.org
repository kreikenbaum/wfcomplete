...
**** WRITE SVM
     - how works
     - multi-class strategies aka ovr vs ovo
...
*** WRITE capture
    ...
    - code:
      ...
      - retrieve ...
*** TODO classification
**** WAIT counter.py: represent trace files
**** KEYWORDS analyse.py: code to classify etc
...
**** MOVE to [[*capture][capture]] one-site.py: retrieve web sites via Tor
...
**** CHECK MOVE to [[*counter.py: represent trace files][counter.py: represent trace files]] usage of counter.py to extract features from pcap
