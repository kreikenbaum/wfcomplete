...
** DANIEL Website Fingerprinting [25/26]
   :PROPERTIES:
   :CUSTOM_ID: wf
   :END:
   #+INDEX: attack
...
*** DANIEL Challenges to Website Fingerprinting: Tor [3/3]
    :PROPERTIES:
...
***** CHECK Measuring Performance
      ...
      main metrics used by almost all authors are[fn::accuracy is
      mostly used in the closed-world case] accuracy, and
      True-Positive- and False-Positive-rate[fn::tpr and fpr are
...
** WRITE Website Fingerprinting [1/6]
   ...
   In the data tables in the appendix, you can see various different
   classifiers.
...
* KEYWORDS Both Training and Testing on the Same Data Sets, All Attacks
...
** CHECK Avoiding Safe Mode on Restart
   ...
   - set the Firefox preference =toolkit.startup.max_resumed_crashes=
     to =-1=,
   - set the environment variable =MOZ_DISABLE_AUTO_SAFE_MODE= (did
     not work in the Tor Browser Bundle),
