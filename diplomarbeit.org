...
** Simple Tor
   ...
   Frank only knows Dave and Bob.\\
    ...
    [[./pictures/How_Tor_Works_3.png]] This closely models the Internet:
...
* ****** OLDOLDOLDOLDOLD ********
  ...
  Saudi-Arabia, and China\citet{china}, more and more
  Internet users search for ways to keep online communication and web
  browsing both private and free of censorship.

  The /Tor/ project\citet{tor-design} provides this. It protects
  whistleblowers, journalists, the people in oppressive
  regimes\citet{jardine2016tor}, even the military, and regular
