...
#+CAPTION[LLaMA evaluation results]: Results for evaluating LLaMA, compared to no defense, and \gls{s}. LLaMA only had 34 sites with at least 30 instances. The size and time \gls{oh} are for the \gls{wf} default setting, as described in the previous Table [[tab:llama-capture]].
#+NAME: tab:llama-eval
...
| \gls{s} medium | 35.54      |      52.55 |      83.88 |      45.76 |
