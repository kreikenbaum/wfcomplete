...
* WRITE Evaluation
  ...
  to show its improvements. First, [[#sub4-tools][WF attacks are compared]] to show
  that they yield comparable results.

  - show that works
  - show that analysis/tools work
  - show if closed-world
    - differentiate a fixed number of pages
    - works, or not
  - show if open-world
    - in/out set
    - big number of background pages
    - works, or not
** KEYWORDS WF Tools
   :PROPERTIES:
