...
*** CHECK Who uses Tor
    ...
    higher security \cite[Section 3]{tor-design}.  Today, it is an
    anonymization network with a diverse user base. It has over 6'000
    nodes[fn::usage numbers from \url{metrics.torproject.org}] and is
    accessed by about two million users daily.
...
**** TODO "seen or recommend" plus citation
*** CHECK History of Tor
    Tor inherits its main design from the Onion Routing Project
