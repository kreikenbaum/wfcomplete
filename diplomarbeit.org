...
** TODO Website Fingerprinting [0/29]
...
**** MOVE to wf2.0, stress that they used *packet sizes*
...
** TODO Evaluation of Defenses [0/4]
*** WRITE Evaluation of Addon
    ...
    - if yes, scenarios (a/b I/II bursts)
    - bursts at simple
    - factor at simple
...
**** MOVE to appendix modules [0/17]                          :appendix:
...
* TODO extract dom tags python
  - diveintopython
  - see code
* CHECK MOVE TO EVAL modified top-100
...
* CHECK MOVE wsgi.py cover traffic server and generator      :appendix:addon:
...
* TODO MOVE npm short installation/description                     :appendix:
* TODO MOVE panchenko v1 different classifiers                         :eval:
...
* TODO MOVE outlier removal                                            :eval:
...
* WRITE MOVE how to set up wfpad                                   :appendix:
...
* WRITE sampling web sites                                             :eval:
  ...
  - link to code
* WRITE MOVE outlier removal                                           :eval:
