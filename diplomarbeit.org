...
** Thesis Structure
   ...
   be skipped given previous knowledge.[fn::@Daniel: ist dieser Satz
   zu flapsig, oder ok?]
...
* Background
  ...
  knowledge of previous attacks and defenses, and machine-learning
  basics.  course themselves.
** The Tor Network
  #+INDEX: onion router
  #+INDEX: onion proxy
  ...
  compromised, it can not link source and destination.
** Tor Website Fingerprinting
   ...
   whom. It assumes that the system is computationally
   ...
   fingerprinting, without anyone realising it.
