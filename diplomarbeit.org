...
* WRITE (after subparts) Evaluation [1/6]
  :PROPERTIES:
...
** PENDING (capture update table to 100, redo? llama orig?) CHECK Defense Evaluation in a Closed World
   :PROPERTIES:
...
** KEYWORDS Defense Evaluation in a Open World
   :PROPERTIES:
   :CUSTOM_ID: sub4-open
   :END:
** KEYWORDS Summary
