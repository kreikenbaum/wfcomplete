...
#+CAPTION: Sequence chart of cover traffic for a known site with embedded probability $< 1$, triggered
...
protocol's minimal traffic size. After reoslving the =overflow=, the
