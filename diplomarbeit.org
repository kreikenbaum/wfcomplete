...
\citet{effective2014}. One of the captured defenses,
WTF-PAD[fn::available at
https://bitbucket.org/mjuarezm/obfsproxy_wfpadtools.git, this thesis'
version at https://github.com/kreikenbaum/capture.git] by
\citet{wtfpad2015}, seemed to be working according to debug output,
but failed to produce significant traffic, as seen in appendix
