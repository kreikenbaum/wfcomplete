...
*** CHECK Extremely Randomized Trees
    ...
    As of the paper, Extra-Trees[fn::as they are also called by the
    author] yield higher accuracy than Random Forests on almost all
    data sets. They offer single feature importances, as requested by
    \cite{critique}.
*** brainstorm
    - induce pattern
      - naive
