...
*** CHECK Measuring Performance
    ...
    |--------------------------+-----------------------+-----------------------|
    |                          | real facebook.com     | real craigslist.org   |
    |--------------------------+-----------------------+-----------------------|
    | predicted facebook.com   | *True Positives (TP)* | False Positives (FP)  |
    | predicted craigslist.org | False Negatives (FN)  | *True Negatives (TN)* |
    |--------------------------+-----------------------+-----------------------|
