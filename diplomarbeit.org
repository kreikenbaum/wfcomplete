...
*** WRITE Wang's KNN
    #+INDEX: attack!kNN
    \cite{effective} achieved high accuracy
    - \cite{effective} achieved high accuracy, set standard
      - knn with dynamically-determined metrics
      - many features
...
**** WRITE Original Classification Methods: Panchenko and Wang's
 ...
 treatment.\cite{xp}
     ...
     is at \url{https://cs.uwaterloo.ca/~t55wang/knn.zip}, the exmple
