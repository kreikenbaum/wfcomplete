...
#+END_EXPORT
  ...
  \cite{SSL}. \cite{panchenko} were the first to successfully attack
  Tor by \gls{wf} under laboratory conditions in 2011.


  Various defenses have been proposed so far (\cite{hintz02},
  \cite{morphing09}, \cite{httpos2011}, \cite{oakland2012-peekaboo},
  \cite{effective2014}, \cite{a-systematic2014}, \cite{wtfpad2015}
  \cite{wang2015walkie},
  \cite{DBLP:journals/popets/CherubinHJ17}). None have been deployed
  ...
  (\cite{quantifying}, \cite{ssl-traffic-analysis}, \cite{hintz02},
  \cite{ccsw09-fingerprinting}, \cite{panchenko},
  \cite{ccs2012-fingerprinting}, \cite{effective2014},
  \cite{panchenko2}, \cite{197185}).
** Contributions
   ...
   state-of-the art attack by \cite{panchenko2}; it also provides a
   way to record web page browsing via Tor.
** PENDING (thesis done) Structure
* Foundations
* ****** OLDOLDOLDOLDOLD ********
...
** Thesis Structure
   ...
   \cite{wang2015walkie} and \cite{wtfpad2015} in chapter [[#ch5-discussion]].
