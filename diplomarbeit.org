...
** WRITE Website Fingerprinting [17/30]
   :PROPERTIES:
   :CUSTOM_ID: wf
   :END:
*** DANIEL Introduction
...
#     [[./pictures/skl-fig-42.328.eps]]
     ...
     \cite[sec.2.8.3]{esl}, this would probably become
     "combinatorially hard".
**** TODO link to basic book (bronstein) for vector space etc
**** WRITE Preparation
     - good results\cite[sec.7.8.1]{kernels}
       - but drawback need additional work priming data than
         f.ex. tree-based or knn, compare f.ex. \cite[sec.10.7]{esl}
     - steps needed
       - outlier removal
       - scaling
...
* KEYWORDS Results and Evaluation [32%]
** EVA Introduction
...
\endhead
  ...
  \\
   \multicolumn{3}{c}{Simple Add-on, Factor 10\%} \\
