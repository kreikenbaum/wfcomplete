...
** CHECK Introduction
   ...
   protect against this, much more serious curtailing of free
   information/speech online, and other kinds of
   metadata-information-gathering, journalists, whistleblowers,
   "normal people" and even military have resorted
   to the Tor anonymity network\cite{who-uses-tor}.

   Unfortunately, Tor's anonymity protection has become compromised under
   ...
   Tor, it is possible to determine the target web page with
   ...
   were proposed. These will be describe in [[#defenses][the subsequent section]],
   showing different classes of defenses and examining some in detail.
** WRITE Website Fingerprinting [14/32]
   :PROPERTIES:
   :CUSTOM_ID: wf
   :END:
*** DANIEL Introduction
...
* KEYWORDS Results and Evaluation [18%]
** WRITE Introduction
   - setup: how to capture
   - wf: how efficient each
     - my eval
     - panchenko
     - wang
   - defenses: how defenses mitigate
     - wfpad
     - addon variants
       - qualitative
         - pix
...
**** CHECK Modified Top-100
     ...
     =urllib=\cite[sec.20.5]{python-lib-ref}.

     The Marionette framework (see Appendix [[#Marionette]]) detects web
     site retrieval errors, evaluation was run with erroneous
     retrievals both included and excluded. Where more than 1/4 of all
     retrievals were erroneous, these sites were dropped from the
     list, as well. These included mostly Chinese sites:
     \url{cntv.cn}, \url{tmall.com}, \url{baidu.com}, \url{china.com},
     \url{tianya.cn}, \url{alipay.com}, \url{163.com},
     \url{taobao.com}, \url{xinhuanet.com}, \url{soso.com},
     \url{sina.com.cn}, \url{qq.com}, \url{sohu.com}, \url{weibo.com},
     \url{jd.com}, and \url{sogou.com}. The site \url{hao123.com}
     seemed to yield some errors, but less than the ratio, so it was
     retained.
