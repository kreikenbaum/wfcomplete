...
#+CAPTION[Size overhead to accuracy trade-off on 100 sites]: Size overhead to accuracy trade-off for thesis' defense, LLaMA-nodelay, and no defense on 100 sites, captured at TU Braunschweig.
#+NAME: fig:oh2acc100
#+ATTR_LATEX: :float t :width 0.7\textwidth
