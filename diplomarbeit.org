...
* WAIT Results
** classifier (ordered by accuracy)
*** liblinear-ovo (multiclass one versus one)
...
*** liblinear-ovo (multiclass one versus rest)
**** call
     - liblinear-ovo-1.96/predict test train.model output
     - liblinear-ovo-1.96/train train
**** result
     Accuracy = 11.1979% (86/768)
*** alle Paketdaten auf duckstein (2+2 GB)
**** result
     MemoryError
     >>> Killed
*** liblinear Crammer-Singer
**** call
