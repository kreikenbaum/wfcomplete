...
particular. A big part of website fingerprinting is \gls{ml}, which is
...
** Defending against Website Fingerprinting
   ...
   increasingly better using \gls{ml}. Website fingerprinting thus effectively
   ...
   a website fingerprinting attacker. As most \gls{ml}, website fingerprinting uses statistical
...
**** Thesis Structure
     ...
     and why website fingerprinting might be a credible threat. \Gls{ml} basic steps
...
** DANIEL Website Fingerprinting Defenses
   ...
   :END:
   This section describes defenses against website fingerprinting as described
   [[#sub2-wf][previously]]. As most \gls{ml}, website fingerprinting uses statistical
   properties of the underlying data. It could possibly be defeated by
