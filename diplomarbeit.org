...
*** EVA K-Nearest-Neighbor-Classifier
    ...
    (\cite[sec.1.3.2]{iml} \cite[sec.2.3.2]{esl}
...
*** CHECK scikit-learn
    The python module scikit-learn\cite{scikit-user-guide} is
    described as a collection of "tools for data mining and data
    analysis".
