...
***** EVA Feature Extraction
      ...
      underlying data.
***** MOVE include in [[#features][Features]]
      - here: count bytes and packets, measure bursts (), ...
***** EVA Classification
      :PROPERTIES:
      :CUSTOM_ID: ml-class
      :END:
...
*** EVA Specific vs General Defenses
...
*** WRITE Attack Results
    ...
    their own data set, it achieved closed-world accuracy
