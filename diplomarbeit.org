...
***** TODO cumul
**** WAIT analyse.py: code to classify etc
...
**** TODO MOVE to [[*analyse.py: code to classify etc][analyse.py: code to classify etc]] transform features to vector :eval:setup:
