...
* Tor Browser
  ...
  list [[file:docs/lit.org::*Software & Services]] is the Tor Browser
  Bundle. This is a modified version of Firefox which uses Tor and
  comes with built-in privacy and security enhancements and Add-ons.
