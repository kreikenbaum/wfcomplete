...
- shoulders of giants
- Daniel: polishing, rejecting, improving, good training
- Basti and his family: encouragement, can-do attitude
- support from family
  - parents
  - Peter and Barbara Boczianowski, Ute Irala
  - Karin Kühner
...
retribution. If its provided anonymity were to be reduced, this would
hamper its purpose, both in actual terms, and because this would
discourage users, as its number of users increase its anonymity.
...
effectively cancelling Tor's anonymity. While this

website fingerprinting can detect the websites visited during anonymized browsing. there is no defense included with Tor yet. new, easily installable defense that has little overhead, is configurable, uses the properties of web traffic to hide which page was visited

- why number of users? answer or understandable
#+TOC: headlines 2
\listoffigures
\listoftables
