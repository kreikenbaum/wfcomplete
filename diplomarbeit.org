...
[[#sub2-wf]] explains how \gls{wf} works in general and on Tor in
...
upon: section [[#sub3-http]] justifies the chosen HTTP traffic model; a
stochastic size cache based on
