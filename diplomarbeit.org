...
* EVA Methods [87%]
  This chapter [[#motivation][motivates briefly this thesis' aim]], then [[#design][describes
  conceptually the design for the generation of cover traffic]].
** DANIEL Motivation
   :PROPERTIES:
...
*** DANIEL HTTP traffic model
    ...
    section.
*** RECHECK How to Distinguish HTML and Embedded Objects
    :PROPERTIES:
