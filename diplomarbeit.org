...
** WRITE Tor Website Fingerprinting Defenses
   ...
   - redo picture with additional graphic of tamaraw and wfpad
   As seen in Figure [[fig:total_packets_in]], not only are the means of
   all distributions increased, their variances have been increased
   even more, to the point of them overlapping.
