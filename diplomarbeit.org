...
integrating most defenses has been complicated for the end-user. This
thesis' task is to develop a defense that uses properties of HTTP
...
save element sizes ([[#sub3-bloomsort]]).
    ...
    3. Kumulierte Vorgehensweise / Designing a HTTP-based WF defense (10-20)
       - secondary problem: how to use
       - problem statement: find a way to effectively obfuscate Tor
         traffic from this attack
