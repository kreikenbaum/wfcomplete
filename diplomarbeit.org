...
*** CHECK Extremely Randomized Trees
    ...
    trees: several decision trees are constructed for subsets of the
    data, and their output is averaged.

    As of the paper, Extra-Trees[fn::as they are also called by the
    autor] yield higher accuracy than Random Forests on almost all
...
*** WRITE Introduction
    ...
    defenses. This is mostly done to ensure the accuracy of said
    methods, but also to highlight differences and peculiarities.
...
** MOVE to intro brainstorm
*** MOVE to [[*Website Fingerprinting][Website Fingerprinting {0/13}]]
     - how to analyse
       - json
       - script: reimplement
