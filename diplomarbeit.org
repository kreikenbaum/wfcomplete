...
** KEYWORDS Defense Overhead
** KEYWORDS Defense Evaluation in a Closed World
   :PROPERTIES:
   :CUSTOM_ID: sub4-closed
   :END:
   - cw: only fixed set of sites
   - here: 100
   - 30 for eval purposes
...
* WRITE Addon: Factor to Overhead
  ...
  - estimate to get to overhead of 295: i(175) \approx 296.9
