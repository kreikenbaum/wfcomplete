...
*** KEYWORDS cover traffic distribution generation
...
**** WRITE 0.15: deployable, base version
     This is the base version which was tested. Despite its
     inaccuracte distinguishing of HTML/embedded objects, it achieves
     an accuracy of ...

      - each request triggers some cover traffic
      - due to bug, no embedded, just HTML
      - strategy 1/2: size cache vs guessing
***** TODO accuracy
...
**** move from here to [[*0.15:%20deployable,%20base%20version][0.15: deployable, base version]]
...
**** MOVE from here to [[*0.18:%20different%20strategies%20for%20target%20site][0.18: different strategies for target site]]
