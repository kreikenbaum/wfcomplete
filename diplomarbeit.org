...
** WRITE Website Fingerprinting [21/25]
   :PROPERTIES:
   :CUSTOM_ID: wf
   :END:
*** DANIEL Introduction
...
*** WRITE k-fingerprinting
    ...
    leafs constitute a "fingerprint". This is then compared via kNN to
    the training fingerprints. If all agree, the trace is classified.
    ...
    - leaf labels, see \cite[sec.42.9.9]{scikit-user-guide} apply
*** WRITE Related Work
    :PROPERTIES:
    :CUSTOM_ID: wfRelated
    :END:
...
** WRITE Website Fingerprinting [1/5]
