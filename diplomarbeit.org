...
** WRITE Website Fingerprinting [22/24]
   :PROPERTIES:
   :CUSTOM_ID: wf
   :END:
*** DANIEL Introduction
...
*** WRITE k-fingerprinting
    ...
    attack. It offers comparable accuracy to wang-knn and CUMUL, with
    higher resistance to defenses than both of these. About 150
    different features are evaluated with a random-forest classifier.
...
*** KEYWORDS CUMUL: SVM vs Extra-Trees
    :PROPERTIES:
    :CUSTOM_ID: svm_vs_et
    :END:
