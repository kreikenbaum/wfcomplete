...
*** EVA Aim: selective cover traffic
    ...
    her country.
** TODO Design and Implementation (=Implementation) [10/17]
*** DANIEL Introduction
...
* TODO Results and Evaluation [21%]
** KEYWORDS Setup
*** EVA sites
...
** KEYWORDS Website Fingerprinting [0/4]
...
*** KEYWORDS trace growth, time difference, effect
    ...
    :END:
    - Table [[tab:time]]
#+CAPTION: Overhead and accuracy, training 07-06, testing on each, sorted by overhead
#+NAME: tab:time
...
#+CAPTION: Growth of trace sizes [byte] by date by domain. Relative.
