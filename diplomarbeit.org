...
*** DANIEL Feature Extraction
    ...
    There are numerous \gls{wf} attacks. F.ex. \cite{effective} achieved
...
** CHECK \glsfirst{wf} Attack Evaluation
   ...
   \cite{LLaMA}, \cite{a-systematic})? To examine this, \gls{wf} attacks are
...
** PENDING (daniel) Closed World
   ...
   |-------------------+------------+------------+------------|
   | llama-nodelay (redo) |         63 |     279.67 |      58.86 |
