...
#+LATEX_HEADER: }}
* KEYWORDS organize [[*Mozilla%20Add-On%20Sdk][addon]] sections
* TODO [#A] Final Sections [0/41]
...
**** WRITE [#A] What is Tor
     - \cite{tor-design}
     - anonymity system
     - normally: sees from whom to whom, even with encryption
     - here: hides this
       - plus: hs
       - plus: censorship avoidance
     - traffic analysis
       - hardens
**** KEYWORDS Who uses Tor
**** KEYWORDS How does Tor Work
**** brainstorm							    :ARCHIVE:
     - origin
     - usage
       - socks
...
**** CHECK Why to hide
   ...
   Yet, there could exist user-friendly ways to hamper, or even to deter,
   this surveillance.
***** TODO bib ddr-verfassung+link
**** brainstorm							    :ARCHIVE:
     - privacy anecdotes
     - offline argument
