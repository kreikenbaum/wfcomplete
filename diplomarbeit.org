...
WANG14 data set is extraordinary in its possible classification
accuracy.
...
To compare these, a Receiver Operating Characteristic (ROC) curve can
be used
#+CAPTION: ROC-Curve for 50 sites with defenseless
#+NAME: fig:wang-roc
[[./pictures/roc-curves-823-824.pdf]]
# (r0, r1) = (r for r in results.list_all() if 40 < r.size < 60)
# rocfig = mplot._init_roc("Receiver operating characteristic (ROC) curves")
# mplot.roc_helper_open_world_binary(r0, fig=rocfig, dot_position=None)
# mplot.roc_helper_open_world_binary(r1, fig=rocfig, dot_position=None)
