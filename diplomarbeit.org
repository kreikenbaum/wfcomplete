...
** WRITE WF Attack Evaluation
   ...
   \cite{effective} was evaluated as well, but KNN showed worse
   results on this thesis' data than CUMUL.

   Appendix [[#appendix-accuracy]] shows evaluation results.
...
testing set. The classifiers trained and tested on the same data sets,
as compared to f.ex. training on data without defense, and testing on
defended data.
