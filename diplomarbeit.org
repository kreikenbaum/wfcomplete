...
** WRITE Analyzing Open World Scenarios
   ...
   \cite{panchenko2} on the WANG14 data set \citep{effective2014} on
   which they present their results[fn::available at
   [[https://cs.uwaterloo.ca/~t55wang/wf.html]]], see Table
   [[tab:open-world-validation]]. As seen in Table [[tab:open-world-all-100]]
   of all results in Appendix [[#app-open-results]], classification
   effectiveness was lower on newly captured data.
