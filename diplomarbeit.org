...
**** KEYWORDS Error estimation of Bloom Sort
...
** KEYWORDS MOVE below [[*panchenko v1 vs cumul][vs cumul]] panchenko v1 different classifiers
...
** TODO Evaluation of Defenses [0/6]
...
*** KEYWORDS sota (practical): wtfpad
    ...
    #+CAPTION: different defense versions with CUMUL, extratrees classifier
    #+ATTR_LATEX: :float nil :width \textwidth
    [[./pictures/google.com__wfpad_vs_disabled.eps]]
        - biggest: tumblr.com (less political)
    #+CAPTION: different defense versions with CUMUL, extratrees classifier
    #+ATTR_LATEX: :float nil :width \textwidth
    [[./pictures/tumblr.com__wfpad_vs_disabled.eps]]
        - medium: netflix.com
    #+CAPTION: different defense versions with CUMUL, extratrees classifier
    #+ATTR_LATEX: :float nil :width \textwidth
    [[./pictures/netflix.com__wfpad_vs_disabled.eps]]
