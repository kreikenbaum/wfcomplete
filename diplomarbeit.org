...
**** What is website fingerprinting
     ...
     #+CAPTION: example 1 of facebook.com traffic
     #+ATTR_LATEX:  :float nil :width 0.45\textwidth
     [[./pictures/facebook_com@1445350531.png]]
     #+CAPTION: example 2 of craigslist.org traffic
     #+ATTR_LATEX:  :float nil :width 0.45\textwidth
     [[./pictures/craigslist_org@1445585277.png]]
     #+CAPTION: example 2 of facebook.com traffic
     #+ATTR_LATEX:  :float nil :width 0.45\textwidth
     [[./pictures/facebook_com@1445698262.png]]

     - kind of traffic analysis
       - without seeing content, deduce information
     - wf: without seeing sender/receiver, deduce which website is being visited
...
**** related work
     - mitchell
     - sklearn
     - herrmann: breakable naive bayes
     - panchenko: svm
