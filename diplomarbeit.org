...
Date:   Fri Apr 1 13:51:07 2016 +0200
                 ...
                 - erster Datensatz
                   ...
                   - am (
                     - 21. Jun 2016
                     - (date --date=@1466502799)
                       - datum aus 0.15.3/json-10/0/amazon.com.json
              2. datensaetze in naehe suchen mit varianten
                 ...
                 - hier sieht man:
                   ...
                   - nocache hat 0.94
              3. eval
              4. wenn resultate: mit spaeteren varianten vergleichen
          - generell:
   ...
   2. check that very-low-accuracy scenario (good) are dated right after
      implementing all (0.18/0.15)
   3. herrmann: good accuracy: should be random guessing (Tor should
      hide sizes)
