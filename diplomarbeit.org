...
#+CAPTION[Comparison of LLaMA to this thesis's defense on 30 sites]: Comparison of LLaMA to this thesis's defense on 30 sites. The top lines shows LLaMA stats, the next two lines try to match first the accuracy, then the size overhead with the new defense. Capturing LLaMA on 100 sites proved infeasible due to the long duration.
...
defense's on 30 sites. In our experiments, original LLaMA consistently
delayed web surfing by an order of magnitude. This yielded 43.67% load
errors due mostly to timeouts (after ~10 minutes). After removing load
errors, 16 of 30 sites had less than 30 usable instances. If these
sites were removed, accuracy against LLaMA rose from 55.46% to
71.26%. Overhead after site removal remained similar. As LLaMAs
original time overhead seems prohibitive, the source code was edited
(a constant was changed) to disable the delay. This version is called
/LLaMA-nodelay/.  Compared to the modified version of LLaMA, this
thesis' defense offers both configurability and a lower size
overhead. Both LLaMA-nodelay and the new defense have negligible time
overhead. Even compared to non-delayed LLaMA, the new defense offers
similar accuracy/size overhead relationship for a much lower time
overhead.
...
distributions to generate cover traffic. This difference is again
illustrated in Figures [[fig:oh2acc100]] and [[fig:oh2acc]].


#+CAPTION: Size Overhead to Accuracy Trade-Off for Thesis' Defense, LLaMA-nodelay, and no defense on 100 sites.
#+NAME: fig:oh2acc100
...
** WRITE Analyzing Open World Scenarios
   :PROPERTIES:
   :CUSTOM_ID: sub4-open
   :END:
   ...
   setting compares a certain number of monitored sites against a
   bigger number of background pages, and is considered more realistic
   \citep[sec.5.1]{effective2014}. Say, Eve knows that her daughter
   Alice might visit any number of pages, but is only interested in
   whether she visits =bob.com=. As described in section
   [[#sub2-ml-measure]], all visits that are wrongly classified as
   =bob.com=, say Alice really visited =myspace.com=, are called
   /false positives/, whereas if Alice visited =bob.com= and it was
   classified as =myspace.com=, is called a /false negative/. Ideally,
   none of these exist. In practice, Eve has to weigh between leniency
   and strictness: would she rather let slip a visit to =bob.com= as
   =myspace.com=, or would she rather check in on her daughter when
   she just visits =myspace.com=, because it was classified as
   =bob.com=?



   The results of the reimplementation closely match those reported by
   \cite{panchenko2} on the WANG14 data set on which they provide
   their results, see Table [[tab:open-world-validation]]. As seen
   in the Table of all results in Appendix , overall accuracy was
#+CAPTION[Open-World Validation]: Validation on 100 sites of the WANG14 \citep{panchenko2} dataset. Since multi-class tpr and fpr have multiple possible definitions \citep{sokolova2009systematic}, only the two-class values were compared.
#+NAME: tab:open-world-validation
#+ATTR_LATEX: :align |l||r | r | r |
| Data source                    | \open Number of instances \close | \open True-Positive-Rate [%] \close | \open False-Positive-Rate [%]\close |
| <30>                           |       <10> |       <10> |       <10> |
|--------------------------------+------------+------------+------------|
| \cite{panchenko2}, two-class   |         90 |      96.92 |       1.98 |
| own experiment, two-class      |         90 |      97.29 |       1.43 |



   - are those results reliable
     - yes: validated on WANG14 (dubbed by CUMUL) dataset
       - reproduce CUMUL's reported values
       - src: online, take link from wang paper if possible, else cumul paper
     - also "validated" by CUMUL ccdf-curves
     - [bit lower accuracy on current datasets
       - wang did not detail how data was captured]
   - so what are the results
     ...
     - detailed comparison
       ...
       - list overhead (size/time), accuracy in closed world, (date?)
       - roc-curves
       - instances (?)
       - confusion matrices
         [[./pictures/confmat_s2018-02-02_r679.pdf]]
         # rd = (r for r in results.for_scenario(sd) if r._ydomains and r.open_world['background_size'] == "auto" and not r.open_world['binary']).next()
         # mplot.confusion_matrix_from_result(rd, zero0=True)
         [[./pictures/confmat_s2018-02-13_r667.pdf]]
         # same for s20 with r20
  ...
  No defense, closely matches Panchenko's recall curve.
...
*** 100 Sites, Sorted by Size Overhead
The results decresed over time, until the capture process was fixed.
...
** TODO [#D] create remainder dynamically from database
* Open-World (False/True--Positive) Results
#+CAPTION[Open-World Results with 100 sites]: Table of all results on 100 sites, sorted by date. The WANG14 and "no defense" datasets have no overhead. If the background-size (bg) is "auto" the same number as in the foreground set were chosen; if "max", the maximum number was chosen.
#+NAME: tab:open-world-validation
#+ATTR_LATEX: :environment longtable :align |l | r || r | r | r | r | r |
|---------------|------------|----------|------|-------|-------|---------------|
|    Scenario   |    Date    | Accuracy |  bg  |  tpr  |  fpr  | size increase |
|---------------|------------|----------|------|-------|-------|---------------|
|   no defense  | 2018-02-02 |   0.55   | auto | 0.609 | 0.425 |      0.00     |
|   no defense  | 2016-09-21 |   0.56   | max  | 0.497 | 0.263 |      0.00     |
|   no defense  | 2016-12-23 |   0.74   | max  | 0.741 | 0.181 |      0.00     |
|   no defense  | 2016-06-17 |   0.92   | max  | 0.817 | 0.024 |      0.00     |
|   no defense  | 2016-11-04 |   0.60   | max  | 0.586 | 0.221 |      0.00     |
|   no defense  | 2016-11-27 |   0.56   | max  | 0.396 | 0.188 |      0.00     |
|   no defense  | 2018-02-02 |   0.54   | max  | 0.646 | 0.523 |      0.00     |
|  new defense  | 2018-02-02 |   0.61   | auto | 0.711 | 0.304 |     37.82     |
|  new defense  | 2018-02-13 |   0.52   | auto | 0.347 | 0.147 |     65.85     |
|   no defense  | 2018-02-02 |   0.82   | auto | 0.846 | 0.171 |      0.00     |
|   no defense  | 2018-02-02 |   0.89   | 100  | 0.992 | 0.900 |      0.00     |
|   no defense  | 2018-02-02 |   0.87   | 200  | 0.988 | 0.855 |      0.00     |
|   no defense  | 2018-02-02 |   0.84   | 500  | 0.973 | 0.710 |      0.00     |
|   no defense  | 2018-02-02 |   0.81   | 1000 | 0.953 | 0.530 |      0.00     |
|   no defense  | 2018-02-02 |   0.80   | 2000 | 0.897 | 0.305 |      0.00     |
|   no defense  | 2018-02-02 |   0.80   | 3000 | 0.878 | 0.236 |      0.00     |
|   no defense  | 2018-02-02 |   0.82   | 5000 | 0.827 | 0.149 |      0.00     |
|   no defense  | 2018-02-02 |   0.84   | max  | 0.814 | 0.123 |      0.00     |
|  new defense  | 2018-02-02 |   0.71   | auto | 0.725 | 0.209 |     22.89     |
|   no defense  | 2016-09-21 |   0.78   | auto | 0.795 | 0.142 |      0.00     |
|   no defense  | 2016-12-23 |   0.83   | auto | 0.854 | 0.082 |      0.00     |
|   no defense  | 2016-06-17 |   0.92   | auto | 0.923 | 0.036 |      0.00     |
|   no defense  | 2016-11-04 |   0.75   | auto | 0.821 | 0.123 |      0.00     |
|   no defense  | 2016-11-27 |   0.80   | auto | 0.829 | 0.140 |      0.00     |
|   no defense  | 2016-12-26 |   0.84   | auto | 0.926 | 0.046 |      0.00     |
|   no defense  | 2016-09-26 |   0.84   | auto | 0.907 | 0.073 |      0.00     |
|   no defense  | 2016-12-26 |   0.87   | auto | 0.899 | 0.044 |      0.00     |
|   no defense  | 2018-01-17 |   0.85   | auto | 0.875 | 0.126 |      0.00     |
|   no defense  | 2016-08-30 |   0.84   | auto | 0.920 | 0.064 |      0.00     |
|   no defense  | 2016-12-02 |   0.84   | auto | 0.849 | 0.069 |      0.00     |
|   no defense  | 2018-02-02 |   0.82   | auto | 0.843 | 0.162 |      0.00     |
|   no defense  | 2018-02-02 |   0.86   | 300  | 0.977 | 0.670 |      0.00     |
|   no defense  | 2018-02-02 |   0.89   | 100  | 0.994 | 0.880 |      0.00     |
|   no defense  | 2018-02-02 |   0.88   | 200  | 0.989 | 0.855 |      0.00     |
|   no defense  | 2018-02-02 |   0.85   | 500  | 0.965 | 0.566 |      0.00     |
|   no defense  | 2018-02-02 |   0.82   | 1000 | 0.943 | 0.446 |      0.00     |
|   no defense  | 2018-02-02 |   0.80   | 2000 | 0.907 | 0.312 |      0.00     |
|   no defense  | 2018-02-02 |   0.81   | 3000 | 0.875 | 0.219 |      0.00     |
|   no defense  | 2018-02-02 |   0.82   | 5000 | 0.842 | 0.157 |      0.00     |
|   no defense  | 2018-02-02 |   0.84   | max  | 0.814 | 0.123 |      0.00     |
|  new defense  | 2018-02-13 |   0.43   | 100  | 0.992 | 0.960 |     65.85     |
|  new defense  | 2018-02-13 |   0.42   | 200  | 0.986 | 0.885 |     65.85     |
|  new defense  | 2018-02-13 |   0.41   | 500  | 0.975 | 0.894 |     65.85     |
|  new defense  | 2018-02-13 |   0.39   | 1000 | 0.926 | 0.764 |     65.85     |
|  new defense  | 2018-02-13 |   0.40   | 2000 | 0.745 | 0.479 |     65.85     |
|  new defense  | 2018-02-13 |   0.44   | 3000 | 0.603 | 0.348 |     65.85     |
|  new defense  | 2018-02-13 |   0.61   | max  | 0.175 | 0.053 |     65.85     |
|  new defense  | 2018-02-13 |   0.52   | auto | 0.345 | 0.144 |     65.85     |
|  new defense  | 2018-02-13 |   0.40   | 1000 | 0.935 | 0.734 |     67.16     |
|  new defense  | 2018-02-13 |   0.40   | 2000 | 0.771 | 0.512 |     67.16     |
|  new defense  | 2018-02-13 |   0.40   | 1000 | 0.935 | 0.734 |     67.16     |
|  new defense  | 2018-02-13 |   0.40   | 2000 | 0.771 | 0.512 |     67.16     |
| LLaMA-nodelay | 2018-02-25 |   0.35   | 1000 | 0.925 | 0.801 |     203.39    |
| LLaMA-nodelay | 2018-02-25 |   0.38   | 2000 | 0.685 | 0.430 |     207.40    |
|   no defense  | 2018-02-02 |   0.83   | auto | 0.829 | 0.137 |      0.00     |
|   no defense  | 2018-02-02 |   0.85   | 4586 | 0.881 | 0.138 |      0.00     |
|   no defense  | 2018-02-02 |   0.85   | 4586 | 0.869 | 0.123 |      0.00     |
| LLaMA-nodelay | 2018-02-25 |   0.43   | 3000 | 0.441 | 0.213 |     207.40    |
| LLaMA-nodelay | 2018-02-25 |   0.55   | 5000 | 0.111 | 0.033 |     207.40    |
| LLaMA-nodelay | 2018-02-25 |   0.59   | 6075 | 0.000 | 0.000 |     207.40    |
| LLaMA-nodelay | 2018-02-25 |   0.34   | 1000 | 0.930 | 0.822 |     207.40    |
| LLaMA-nodelay | 2018-02-25 |   0.51   | 4184 | 0.170 | 0.055 |     207.40    |
|   no defense  | 2018-02-02 |   0.60   | 5000 | 0.544 | 0.346 |      0.00     |
|   no defense  | 2018-02-02 |   0.83   | 5000 | 0.839 | 0.140 |      0.00     |
|   no defense  | 2018-02-02 |   0.85   | 4622 | 0.879 | 0.138 |      0.00     |
|   no defense  | 2018-02-02 |   0.86   | 4538 | 0.879 | 0.131 |      0.00     |
|   no defense  | 2018-02-02 |   0.61   | 4586 | 0.528 | 0.315 |      0.00     |
|   no defense  | 2018-02-02 |   0.86   | 4586 | 0.877 | 0.131 |      0.00     |
|   no defense  | 2018-02-02 |   0.85   | 4586 | 0.877 | 0.150 |      0.00     |
|   no defense  | 2018-02-02 |   0.86   | 4586 | 0.880 | 0.133 |      0.00     |
|   no defense  | 2018-02-02 |   0.61   | 4586 | 0.511 | 0.310 |      0.00     |
|   no defense  | 2018-02-02 |   0.61   | 4586 | 0.527 | 0.316 |      0.00     |
|   no defense  | 2018-02-02 |   0.61   | 4586 | 0.523 | 0.313 |      0.00     |
|   no defense  | 2018-02-02 |   0.61   | 4586 | 0.521 | 0.311 |      0.00     |
|   no defense  | 2018-02-02 |   0.61   | 4586 | 0.530 | 0.312 |      0.00     |
|   no defense  | 2018-02-02 |   0.61   | 4538 | 0.527 | 0.318 |      0.00     |
|   no defense  | 2018-02-02 |   0.61   | 4622 | 0.565 | 0.347 |      0.00     |
|   no defense  | 2018-02-02 |   0.82   | 1000 | 0.999 | 0.998 |      0.00     |
|   no defense  | 2018-02-02 |   0.70   | 2000 | 1.000 | 0.996 |      0.00     |
|   no defense  | 2018-02-02 |   0.66   | 3000 | 0.874 | 0.658 |      0.00     |
|   no defense  | 2018-02-02 |   0.60   | 5000 | 0.542 | 0.345 |      0.00     |
|   no defense  | 2018-02-02 |   0.60   | 6754 | 0.000 | 0.000 |      0.00     |
|   no defense  | 2018-02-02 |   0.62   | 4538 | 0.731 | 0.500 |      0.00     |
|   no defense  | 2018-02-02 |   0.82   | 1000 | 0.945 | 0.439 |      0.00     |
|  new defense  | 2018-02-13 |   0.59   | 5000 | 0.615 | 0.426 |     67.16     |
|  new defense  | 2018-02-13 |   0.52   | 5000 | 0.000 | 0.000 |     67.16     |
|  new defense  | 2018-02-13 |   0.82   | 1000 | 1.000 | 1.000 |     67.16     |
|  new defense  | 2018-02-13 |   0.70   | 2000 | 0.998 | 0.989 |     67.16     |
|  new defense  | 2018-02-13 |   0.63   | 3000 | 0.834 | 0.669 |     67.16     |
|  new defense  | 2018-02-13 |   0.59   | 5000 | 0.618 | 0.430 |     67.16     |
|  new defense  | 2018-02-13 |   0.60   | 6780 | 0.000 | 0.000 |     67.16     |
|  new defense  | 2018-02-13 |   0.60   | 4554 | 0.700 | 0.498 |     67.16     |
|  new defense  | 2018-02-13 |   0.38   | 1000 | 0.915 | 0.757 |     67.16     |
|  new defense  | 2018-02-13 |   0.40   | 2000 | 0.722 | 0.456 |     67.16     |
|  new defense  | 2018-02-13 |   0.44   | 3000 | 0.556 | 0.297 |     67.16     |
|  new defense  | 2018-02-13 |   0.52   | 5000 | 0.000 | 0.000 |     67.16     |
|  new defense  | 2018-02-13 |   0.61   | 6780 | 0.175 | 0.053 |     67.16     |
|  new defense  | 2018-02-13 |   0.52   | 4554 | 0.410 | 0.183 |     67.16     |
| LLaMA-nodelay | 2018-02-25 |   0.81   | 1000 | 0.996 | 0.971 |     207.40    |
| LLaMA-nodelay | 2018-02-25 |   0.68   | 2000 | 0.985 | 0.951 |     207.40    |
| LLaMA-nodelay | 2018-02-25 |   0.62   | 3000 | 0.815 | 0.647 |     207.40    |
|   no defense  | 2018-02-02 |   0.82   | 1000 | 0.946 | 0.456 |      0.00     |
|   no defense  | 2018-02-02 |   0.80   | 2000 | 0.914 | 0.313 |      0.00     |
|   no defense  | 2018-02-02 |   0.82   | 3000 | 0.891 | 0.219 |      0.00     |
|   no defense  | 2018-02-02 |   0.83   | 5000 | 0.847 | 0.158 |      0.00     |
|   no defense  | 2018-02-02 |   0.84   | 6754 | 0.827 | 0.119 |      0.00     |
|   no defense  | 2018-02-02 |   0.82   | 4538 | 0.846 | 0.153 |      0.00     |
|  new defense  | 2018-03-28 |   0.82   | 1000 | 0.998 | 0.960 |     142.22    |
|  new defense  | 2018-03-28 |   0.71   | 2000 | 0.990 | 0.941 |     142.22    |
|  new defense  | 2018-03-28 |   0.64   | 3000 | 0.895 | 0.748 |     142.22    |
|  new defense  | 2018-03-28 |   0.59   | 5000 | 0.589 | 0.402 |     142.22    |
|  new defense  | 2018-03-28 |   0.59   | 6557 | 0.000 | 0.000 |     142.22    |
|  new defense  | 2018-03-28 |   0.26   | 1000 | 0.923 | 0.787 |     142.22    |
|  new defense  | 2018-03-28 |   0.33   | 2000 | 0.645 | 0.391 |     142.22    |
|  new defense  | 2018-03-28 |   0.39   | 3000 | 0.444 | 0.245 |     142.22    |
|  new defense  | 2018-03-28 |   0.59   | 6557 | 0.000 | 0.000 |     142.22    |
|  new defense  | 2018-03-28 |   0.59   | 5000 | 0.589 | 0.402 |     142.22    |
|  new defense  | 2018-03-28 |   0.59   | 6557 | 0.000 | 0.000 |     142.22    |
|  new defense  | 2018-03-28 |   0.26   | 1000 | 0.923 | 0.787 |     142.22    |
...
|  new defense  | 2018-03-28 |   0.26   | 1000 | 0.923 | 0.787 |     142.22    |
|  new defense  | 2018-03-28 |   0.33   | 2000 | 0.645 | 0.391 |     142.22    |
|     WANG14    | 2014-05-23 |   0.93   | 1000 | 0.985 | 0.051 |      0.00     |
|     WANG14    | 2014-05-23 |   0.94   | 2000 | 0.982 | 0.043 |      0.00     |
|     WANG14    | 2014-05-23 |   0.94   | 3000 | 0.977 | 0.028 |      0.00     |
|     WANG14    | 2014-05-23 |   0.95   | 5000 | 0.978 | 0.019 |      0.00     |
|     WANG14    | 2014-05-23 |   0.96   | 9000 | 0.973 | 0.014 |      0.00     |
|     WANG14    | 2014-05-23 |   0.95   | 8303 | 0.976 | 0.016 |      0.00     |
|     WANG14    | 2014-05-23 |   0.93   | 1000 | 0.985 | 0.066 |      0.00     |
|     WANG14    | 2014-05-23 |   0.93   | 2000 | 0.981 | 0.040 |      0.00     |
|     WANG14    | 2014-05-23 |   0.94   | 3000 | 0.982 | 0.029 |      0.00     |
|     WANG14    | 2014-05-23 |   0.95   | 5000 | 0.977 | 0.019 |      0.00     |
|     WANG14    | 2014-05-23 |   0.96   | 9000 | 0.973 | 0.014 |      0.00     |
|     WANG14    | 2014-05-23 |   0.95   | 8303 | 0.968 | 0.013 |      0.00     |
|  new defense  | 2018-03-28 |   0.39   | 3000 | 0.444 | 0.245 |     142.22    |
|  new defense  | 2018-03-28 |   0.59   | 6557 | 0.000 | 0.000 |     142.22    |
|  new defense  | 2018-02-02 |   0.82   | 1000 | 1.000 | 0.991 |     37.89     |
|  new defense  | 2018-02-02 |   0.70   | 2000 | 1.000 | 0.993 |     37.89     |
|  new defense  | 2018-02-02 |   0.65   | 3000 | 0.859 | 0.683 |     37.89     |
|  new defense  | 2018-02-02 |   0.60   | 5000 | 0.653 | 0.456 |     37.89     |
|  new defense  | 2018-02-02 |   0.59   | 6783 | 0.000 | 0.000 |     37.89     |
|  new defense  | 2018-02-02 |   0.61   | 4622 | 0.723 | 0.511 |     37.89     |
|  new defense  | 2018-02-02 |   0.59   | 1000 | 0.928 | 0.656 |     37.89     |
|  new defense  | 2018-02-02 |   0.57   | 2000 | 0.835 | 0.474 |     37.89     |
|  new defense  | 2018-02-02 |   0.59   | 3000 | 0.733 | 0.327 |     37.89     |
|  new defense  | 2018-02-02 |   0.64   | 5000 | 0.593 | 0.203 |     37.89     |
|  new defense  | 2018-02-02 |   0.68   | 6783 | 0.443 | 0.110 |     37.89     |
|  new defense  | 2018-02-02 |   0.64   | 4622 | 0.636 | 0.227 |     37.89     |
|---------------|------------|----------|------|-------|-------|---------------|
# def fix(r):
...
# print results.to_table(totable, fields_plus_names=(lambda r: [r.scenario.name, r.scenario.date, "{:.2f}".format(r.score), r.background_size, "{:.3f}".format(r.open_world['tpr']), "{:.3f}".format(r.open_world['fpr']), "{:.2f}".format(r.size_overhead)], ["Scenario","Date", "Accuracy", "bg", "tpr", "fpr", "size increase"]))
