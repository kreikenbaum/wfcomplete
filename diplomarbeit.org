...
described inf section [[#sub4-setup]]. Section [[#sub4-attack]] describes how
...
- does defense work
  ...
  - [what about other attacks]
    - why CUMUL
      - comparable as of all studies
        - k-FP
        - rimmer
    - why not rimmer
      - lots (!) of data needed
      - high-power GPU needed
  https://gitlab.com/kreikenbaum/classify.git
