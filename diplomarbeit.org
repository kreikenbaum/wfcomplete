...
*** TODO effect of bloom - bache
    - decrease for first measure
    - not much effect later
*** more                                                            :ARCHIVE:
...
configurability. It compares favorably to CUMUL: where metrics exist,
it yields the same accuracy reduction for much lower overhead, or
