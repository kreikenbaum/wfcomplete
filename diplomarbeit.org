...
**** WRITE Classifiers
     - once features exist, map these to classes/class probab
...
* WRITE Results and Evaluation [51%]
** DANIEL Introduction
...
** WRITE Evaluation of Defenses [1/13]
*** WAIT Introduction
    :PROPERTIES:
...
* WRITE Testing Results different defenses
...
* KEYWORDS Outlier Removal Results with Extra-Trees Classifier
  #+ATTR_LATEX: :align |r||n{1}{4}|n{1}{4}|n{1}{4}|n{1}{4}|n{1}{4}|n{1}{4}|n{1}{4}|n{1}{4}|n{3}{4}|
...
** CHECK Avoiding safe mode on restart
   ...
   - you can set the environment variable =MOZ_DISABLE_AUTO_SAFE_MODE=
     (did not work in Tor Browser Bundle version ...),
   - or --- as a last resort --- you can remove the
     =toolkit.startup.recent_crashes= line in the =prefs.js= config
     file which saves the number of consecutive kills via =sed -i
