...
#+OPTIONS: H:6
* WAIT Summary
* TODO Basics (=basics) [30%]
** WRITE Website Fingerprinting [9/29]
*** DANIEL Introduction
...
*** DANIEL Early defenses
    ...
    an adversary could simply train on modified data. This addon is
    explicitly named in
...
**** MOVE to [[*Why HTTP-shaped cover traffic][Why HTTP-shaped cover traffic]]
...
* TODO MOVE above [[*Summary][Summary]] Acknowledgements
  - Dr. med. Dr. phil. Eva
  - Daniel Arp
...
* TODO MOVE to end of [[*Cover Traffic Server][Cover Traffic Server]] Non-parallelized web server for cover traffic [0/2]
  :PROPERTIES:
