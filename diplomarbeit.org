...
** WRITE Website Fingerprinting [13/33]
*** DANIEL Introduction
...
**** CHECK soft margin classifiers
     ...
     This yields the equations $y_i( \langle w, xi \rangle +b) \ge 1 - \xi_i$ for the
...
*** DANIEL Introduction
    ...
    f.ex.\space{}\cite[ch.1.7]{DBLP:books/daglib/0001977}]. It exploits
...
* KEYWORDS Results and Evaluation [23%]
** KEYWORDS Setup
*** WRITE Introduction
    - sites for capture
...
*** KEYWORDS alternate classification: panchenko and wang's code
    - why:
...
treatment.
    ...
    - wang: data sets until study (2014)
      - data format: one file per trace, named class_id-trace_num
        - lines are time(float) \t packet/cell length
        - [ *positive out, neg in* ]
...
*** WRITE which features help most in classification
    ...
    - graph
      ...
      - caption: first four are
        ...
        - outSize
        - inSize
** KEYWORDS Evaluation of Defenses [1/8]
...
*** MOVE integrate [[*evaluation][evaluation]] to more thorough evaluation
