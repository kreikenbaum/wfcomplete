...
***** MOVE to [[*Cache (approximate) sizes using Bloom Filters][Cache (approximate) sizes using Bloom Filters]]
...
***** TODO Choice: Cache (approximate) sizes using Bloom Filters
****** WRITE Introduction
