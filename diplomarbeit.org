...
#+TODO: KEYWORDS WRITE CHECK EVA DANIEL | FINISHED
#+TODO: TODO | WAIT DONE
...
** EVA Tor [0/7]
   ...
   In recent years, Tor has also provided censorship circumvention to
   people in oppressive regimes.\cite{tor-spec-pt}.
*** CHECK Who uses Tor
    One of Tor's main design goals was usability, as more users mean
    higher security \cite[sec. 3]{tor-design}.  Today, it is an
    anonymization network with a diverse user base. It has over 6'000
    nodes and is accessed by more than 3 million clients daily.

    The main user groups as listed by the Tor Project
    \cite{who-uses-tor}, in order, are normal people, journalists and
    their audience, military, law enforcement officers, activists &
    whistleblwers, high & low profile people, business executives,
    bloggers, and IT professionals.

    They use it for diverse purposes, such as privacy, censorship
    avoidance, covert ops, publishing, safety, online surveillance,
    anonymous tip lines, whistleblowing, blogging private opinions,
    evaluating competition, and troubleshooting IT systems.\cite{who-uses-tor}
**** TODO update client numbers with footnote: metrics.torproject.org
**** TODO maybe ref to anonymity loves company
...
* TODO Results and Evaluation [0/7]
