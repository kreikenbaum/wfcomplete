...
**** KEYWORDS SVM
     - how works
       ...
       - soft margin classifier: does not
     - multi-class strategies aka ovr vs ovo (vs ecoc)
       ...
       - multi-class: train one for each class (ovr) or one for each
         ...
         - error-correcting codes, mention elemstatlearn p.625
           - or web-dl original paper
           - used by k-forest
     - kernel trick
     - parameter estimation
***** TODO check page elemstatlearn printed
***** TODO link to smola-book
***** TODO link to basic book (bronstein) for vector space ...
**** WRITE wang
     - improved detection
     - many features
...
** KEYWORDS MOVE ONE STEP ABOVE VS CUMUL panchenko v1 different classifiers
...
** WAIT Problematic websites
   ...
   - wait for [[file:~/da/da.org::*klassifikator][klassifikator {0/12}.plan.2]]
** brainstorm                                                       :ARCHIVE:
   - describe setup
     - which sites, why
