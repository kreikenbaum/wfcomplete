...
**** WRITE Modified Top-100
     ...
     [[#top-100]]. Due to the multiple error, the 100-site list used by
     \cite{effective} was also used.[fn::available at \url{}]
***** TODO knnsitelist url
**** DANIEL 30 sites
     :PROPERTIES:
     :CUSTOM_ID: 30sites
     :END:
...
**** WRITE Original Classification Methods: Panchenko and Wang's
 ...
 treatment.\cite{xp}
     ...
     \cite{panchenko2}, namely those mentioned in [[#split][split]] and [[#outlier_removal][outlier
     removal]].
