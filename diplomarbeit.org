...
** CHECK Tor Website Fingerprinting Defenses
   ...
   # created using mplot.py:total_packets_in, see name for scenarios+sites
   #+CAPTION[distribution of number of total incoming packets, thesis defense]: distribution of number of total incoming packets, thesis defense the 5aI setting has small overhead, the 30aI setting average
   ...
   overlapping. This figure illustrates that this thesis' defense more
...
** CHECK Summary
   The previous sections presented the basics of Tor, WF attacks, its
   basis of machine learning, and finally defenses against it. It also
   gave a first glimpse at this thesis' new defense.
