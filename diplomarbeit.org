...
** WRITE Website Fingerprinting [20/27]
   :PROPERTIES:
   :CUSTOM_ID: wf
   :END:
*** DANIEL Introduction
...
*** CHECK K-Nearest-Neighbor-Classifier
...
*** KEYWORDS algo
    1. outlier removal
       - creates new input dir
         - closed world
           #+BEGIN_SRC sh
             python ./feature-scripts/outlier-removal.py -in ./foreground-data/ -out ./foreground-data-OR/ -setting CW -randomInstances NO -instances 40 -referenceFormat tcp -outlierRemoval Simple -ignoreOutlier YES
           #+END_SRC
         - open world
           - foreground TODO
    ...
    2. generate libsvm input
       - closed world
         #+BEGIN_SRC sh
           python ./feature-scripts/generate-feature.py -in ./foreground-data-OR/ -out ./output/ -setting CW -classifier CUMULATIVE -force YES -features 100 -randomInstances NO -dataSet CW -instances 40
         #+END_SRC
       - open world
         - foreground
         #+BEGIN_SRC sh
           python ./feature-scripts/generate-feature.py -in ./foreground-data-OR/ -out ./output/ -setting OW_FG -dataSet FG -classifier CUMULATIVE -force YES -features 100 -randomInstances NO -instances 1
         #+END_SRC
         - background

    3. train svm
       #+BEGIN_SRC sh
         ./libsvm-3.20-src/svm-train -v 10 ./output/CW_TCP ./output/CW_TCP.model
       #+END_SRC
       f.ex. for closed world-data
    4. use svm
       #+BEGIN_SRC sh
         ./libsvm-3.20-src/svm-predict ./output/CW_TCP  ./output/CW_TCP.model ./output/CW_TCP.output
       #+END_SRC
