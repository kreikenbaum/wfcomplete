...
|--------------------+-------------------------+-------------------------|
  ...
  Looking at the top-5 false-positive sites in detail:
  ...
  - google.com also serves international content. Yet, its traces show
    low variance. While google.com sister sites, say google.fi, were
    removed from the foreground set, the background set contained
    hundreds of google sites as well.
