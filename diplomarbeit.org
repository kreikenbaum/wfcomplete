...
To do this, real Tor web browsing should be closely
reproduced. [[https://www.torproject.org/download/download-easy.html.en][The
current Tor Browser Bundle]] downloads the web sites traces: it is
based on the Firefox Browser, which provides the Marionette framework
\citep{marionette} for instrumentation. To be able to evaluate the WTF-PAD
\citep{wtfpad2015} defense[fn::provided at
...
distuinguishes only between the main sites, say its aim is to
distinguish [[http://uol.com.br]]'s and [[http://etsy.com]]'s traces. This
section will presents the results of closed-world analysis. It first
compares the accuracy of \citet{panchenko2}'s original to the
re-implemetation on defenseless traces.
...
Table [[tab:closed-world-accuracy]] presents the main comparison of CUMUL
\citep{panchenko2} to its reimplementation. Appendix
[[#appendix-accuracy]] shows more evaluation results. In most cases, the
original CUMUL attack and the reimplementation had similar
results. This validates that the CUMUL-reimplementation was used as
the main method of evaluating the extension.
...
*** Reproducing attack accuracy
 ...
 - why can you be sure that this works comparably
...
- classification code at https://gitlab.com/kreikenbaum/classify.git
