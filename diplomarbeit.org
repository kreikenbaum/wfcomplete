...
** How Tor Works
  ...
  actors. Web services that run behind Tor hidden services tend to be
  much smaller and contain a smaller number of embedded objects
  \citep[sec.5.2]{DBLP:journals/popets/CherubinHJ17}.
...
# mplot.traces([wiki[x-1] for x in [5, 26, 45, 35, 32, 24, 44, 1]]) #
   ...
   (\citet{panchenko2}, \citet{effective2014} \citet{hayes197185},
...
*** Feature Extraction
    ...
    \citet{ssl-traffic-analysis}, \cite{hintz02}) only use packet
    ...
    \citep[sec.V-B]{panchenko2}. \citet{kfingerprint}, in addition to
...
*** Classification
    ...
    classifiers, such as \gls{svm} \citep{cortes1995support} form an
    internal model from which further input data is
    classified. Others, notably k-Nearest-Neighbors, classify directly
    without an intermediary model. Most classifiers have configuration
    parameters. For \glspl{svm}, which CUMUL \cite{panchenko2}
    applies, these are the regularization parameter $C$ which weighs
    how much to penalize outliers and the RBF-kernel width $\gamma$, see
    Figure [[fig:C-gamma-effect]].
...
#     [[./pictures/skl-fig-42.328.eps]]
     ...
     These parameters need to be adjusted to achieve optimal
     classification accuracy, while avoiding overfitting to the
     training data. One way to avoid this overfitting is
     cross-validation \citep{breiman1992submodel}: The data set is
     split into $k$ disjoint subsets, called /folds/, of equal
     size. Of those, $k-1$ are used combinedly for training the
     classifier, while the last is used for prediction evaluation. In
     other words, for each run, $k-1$ folds are used as training data,
     while the last fold is used as testing data. The accuracy over
     all folds is averaged. CUMUL\citep{panchenko2} uses 10-fold
     cross-validation.
...
HTML page, plus the number of embedded elements, possibly providing more
closely tailored cover traffic. A first comparison on the top 10 pages
yields approximately 7% higher accuracy reduction when using the cache. On 30
pages, this effect is reversed, albeit lower. All sets of traces were
captured with a time-gap of one to three months after configuration
variable for caching made it possible. The decrease might be due to
the top sites increasing their sizes less, and being generally
...
obfuscation for much less space overhead.
** Capture Pitfalls
   :PROPERTIES:
...
this with the =.exit= domain names \citep[sec.2]{address-spec}.
...
** Complete 100 Sites CUMUL Results, Sorted by Size Overhead
   ...
   :END:
# code, see [[tab:ohs-vs-acc-100]]

|               |        |            |  <4> |     <7> |     <7> |     <7> |
|---------------+--------+------------+------+---------+---------+---------|
| Scenario      | Site   |       Date | OR-Level | Accuracy | Size o.h. [%] | Time o.h. [%] |
|---------------+--------+------------+------+---------+---------+---------|
| SCT           | mlsec  | 2016-06-04 |    2 |    0.78 |   14.94 |   26.32 |
| SCT           | mlsec  | 2016-06-04 |    0 |    0.79 |   18.23 |   41.70 |
| defenseless   | mlsec  | 2016-06-17 |    2 |    0.90 |    0.00 |    0.00 |
| defenseless   | mlsec  | 2016-06-17 |    2 |    0.91 |    0.00 |    0.00 |
| defenseless   | mlsec  | 2016-06-17 |    2 |    0.91 |    0.00 |    0.00 |
| SCT 5         | mlsec  | 2016-09-23 |    2 |    0.87 |    7.03 |    2.83 |
| defenseless   | mlsec  | 2016-11-04 |    2 |    0.71 |    0.00 |    0.00 |
| defenseless   | mlsec  | 2017-10-08 |    2 |    0.47 |    0.00 |    0.00 |
| LLaMA-nodelay | mlsec  | 2017-10-18 |    2 |    0.41 |  294.80 |   75.02 |
| LLaMA-nodelay | mlsec  | 2017-10-18 |    2 |    0.43 |  294.80 |   75.02 |
| defenseless   | mlsec  | 2017-10-22 |    0 |    0.43 |    0.00 |    0.00 |
| defenseless   | mlsec  | 2017-10-22 |    2 |    0.44 |    0.00 |    0.00 |
| defenseless   | mlsec  | 2017-11-05 |    2 |    0.48 |    0.00 |    0.00 |
| LLaMA-nodelay | mlsec  | 2017-11-07 |    2 |    0.43 |  708.98 |   72.39 |
| defenseless   | mlsec  | 2017-11-15 |    2 |    0.50 |    0.00 |    0.00 |
| SCT           | mlsec  | 2017-11-21 |    2 |    0.37 |  397.37 |   69.82 |
| SCT           | mlsec  | 2017-11-24 |    2 |    0.30 |  654.68 |   80.88 |
| LLaMA-nodelay | mlsec  | 2017-11-28 |    2 |    0.61 |  254.32 |  318.52 |
| defenseless   | mlsec  | 2018-01-17 |    2 |    0.93 |    0.00 |    0.00 |
| SCT heavy     | mlsec  | 2018-01-29 |    2 |    0.25 |  147.32 |   22.72 |
| defenseless   | gcloud | 2018-01-30 |    2 |    0.95 |    0.00 |    0.00 |
| defenseless   | mlsec  | 2018-02-02 |    2 |    0.92 |    0.00 |    0.00 |
| SCT light     | gcloud | 2018-02-02 |    2 |    0.79 |   22.89 |   17.49 |
| SCT heavy     | gcloud | 2018-02-02 |    2 |    0.66 |   37.82 |   14.69 |
| LLaMA-nodelay | gcloud | 2018-02-11 |    2 |    0.45 |  213.02 |   14.79 |
| defenseless   | gcloud | 2018-02-11 |    2 |    0.95 |    0.00 |    0.00 |
| SCT light     | mlsec  | 2018-02-13 |    2 |    0.43 |   61.81 |   22.23 |
| LLaMA-nodelay | mlsec  | 2018-02-25 |    2 |    0.36 |  205.18 |   29.04 |
| defenseless   | mlsec  | 2018-03-15 |    2 |    0.93 |    0.00 |    0.00 |
| SCT heavy     | mlsec  | 2018-03-28 |    2 |    0.26 |  142.22 |   28.16 |
| SCT 5aI       | mlsec  | 2018-05-16 |    2 |    0.61 |   61.54 |   19.38 |
| LLaMA         | mlsec  | 2018-07-17 |    2 |    0.33 |   28.03 |  845.82 |
| LLaMA         | mlsec  | 2018-07-17 |    2 |    0.33 |   28.03 |  845.82 |
| LLaMA         | mlsec  | 2018-07-17 |    2 |    0.21 |     nan |     nan |
| LLaMA         | mlsec  | 2018-07-17 |    0 |    0.31 |   44.44 |  765.05 |
| defenseless   | mlsec  | 2018-08-03 |    2 |    0.87 |    0.00 |    0.00 |
| defenseless   | mlsec  | 2018-08-03 |    2 |    0.87 |    0.00 |    0.00 |
| defenseless   | mlsec  | 2018-08-03 |    2 |    0.87 |    0.00 |    0.00 |
| defenseless   | mlsec  | 2018-08-03 |    2 |    0.93 |    0.00 |    0.00 |
| defenseless   | mlsec  | 2018-08-03 |    2 |    0.93 |    0.00 |    0.00 |
| defenseless   | mlsec  | 2018-08-03 |    2 |    0.87 |    0.00 |    0.00 |
| SCT medium    | mlsec  | 2018-08-23 |    2 |    0.08 |  -77.30 |  -12.13 |
| SCT medium    | mlsec  | 2018-08-23 |    2 |    0.16 |   74.95 |   24.17 |
| SCT medium    | mlsec  | 2018-08-23 |    2 |    0.08 |  -77.30 |  -12.13 |
| defenseless   | mlsec  | 2018-08-31 |    2 |    0.51 |    0.00 |    0.00 |
| defenseless   | mlsec  | 2018-08-31 |    2 |    0.34 |    0.00 |    0.00 |
| defenseless   | mlsec  | 2018-08-31 |    2 |    0.34 |    0.00 |    0.00 |
| defenseless   | mlsec  | 2018-08-31 |    2 |    0.50 |    0.00 |    0.00 |
| defenseless   | mlsec  | 2018-09-07 |    2 |    0.94 |    0.00 |    0.00 |
| SCT medium    | mlsec  | 2018-09-10 |    2 |    0.36 |   91.66 |   44.53 |
| SCT medium    | mlsec  | 2018-09-10 |    2 |    0.53 |   81.91 |   44.74 |
| SCT medium    | mlsec  | 2018-09-10 |    2 |    0.53 |   83.88 |   45.76 |
| SCT light     | mlsec  | 2018-09-13 |    2 |    0.58 |   60.43 |   64.73 |
| SCT light     | mlsec  | 2018-09-13 |    2 |    0.43 |   64.15 |   54.28 |
| SCT light     | mlsec  | 2018-09-13 |    2 |    0.57 |   63.37 |   65.59 |
| SCT heavy     | mlsec  | 2018-09-16 |    2 |    0.39 |   95.07 |   52.15 |
| SCT heavy     | mlsec  | 2018-09-16 |    2 |    0.30 |  118.73 |   47.33 |
| SCT heavy     | mlsec  | 2018-09-16 |    2 |    0.46 |  130.04 |   50.37 |
| SCT heavy     | mlsec  | 2018-10-01 |    2 |    0.28 |  146.68 |    6.74 |
| SCT medium    | mlsec  | 2018-10-05 |    2 |    0.39 |   91.50 |    3.89 |
| SCT medium    | mlsec  | 2018-10-05 |    2 |    0.39 |   91.50 |    3.89 |
| SCT medium    | mlsec  | 2018-10-05 |    2 |    0.39 |   91.50 |    3.89 |
| defenseless   | mlsec  | 2018-10-17 |    2 |    0.92 |    0.00 |    0.00 |
| LLaMA-nodelay | mlsec  | 2018-10-29 |    2 |    0.48 |  250.38 |   20.04 |
|---------------+--------+------------+------+---------+---------+---------|
...
* Open-World (False/True--Positive) Results
  ...
  :END:
The WANG14 data set shows higher accuracy than many other captures. It also shows higher true- and false positive rates. Its original data files were lost in a hard drive crash.
