...
*** MOVE one above (above or) KEYWORDS classification
    :PROPERTIES:
...
**** MOVE to [[#classification]] transform to panchenko-attributes
...
**** TODO effect of panchenko's weighting schema
...
* WRITE MOVE to appendix how to set up WTF-PAD
...
** MOVE from here to [[#distinguish_HTML_embedded][How to distinguish HTML and embedded objects]]
