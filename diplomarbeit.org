...
analyzed. \citet{effective2014} and \cite{panchenko2} provide their
...
distinguishes only between the main sites, say Eve's aim is to see if
Alice visits =bob.com='s or her uncle =charlie.com='s traces, assuming
both are being monitored by Eve. This section presents the results of
closed-world analysis. It first compares the accuracy of
\citet{panchenko2}'s original to the re-implementation on defenseless
traces.
...
illustrated in Figure [[fig:oh2acc100]].
...
** KEYWORDS Analyzing Open World Scenarios
   :PROPERTIES:
   :CUSTOM_ID: sub4-open
   :END:
