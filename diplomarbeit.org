...
** TODO Website Fingerprinting [0/21]
...
*** WRITE website fingerprinting 1.0
    ...
    - on feature importances:
      ...
      - k-forest
      - wang implicit
**** MOVE between [[*What%20happens%20during%20a%20website%20request][below]] and [[*Hurdles%20to%20website%20fingerprinting][Hurdles to website fingerprinting]]
*** CHECK What happens during a (HTTP) website request
    ...
    answers with that HTML page. The browser then requests objects
    embedded into that page, such as images, stylesheets, fonts,
    scripts, etc. Each of these files has a specific size.
