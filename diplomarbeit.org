...
*** CHECK Classification
    ...
    -- assign them to webpages -- using various /classifiers/. Each
    classifier needs to be trained with /training data/: feature
    vectors with their classes. With this, it can predict the classes
    of /test data/.

    How this happens differs from classifier to classifier; most also
    have configuration parameters to fine-tune classification.
    ...
    classified. Others, such as [[*K-Nearest-Neighbor-Classifier][k-Nearest-Neighbors]] classify directly
