...
#     [[./pictures/skl-fig-42.328.eps]]
    ...
    equal size $\pm 1$. Of those, $k-1$ are used combinedly for training the
    ...
    while the last fold is used as testing data. The accuracy over all
    folds is averaged. CUMUL\citep{panchenko2} uses 10-fold
    cross-validation.
