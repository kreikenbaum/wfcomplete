...
* CHECK Evaluation
  ...
  small fixed number of pages. Finally, the defenses need to [[#sub4-open][show that
  they work in an open-world scenario]], which has many background-page
  retrievals added to the mix.
** WRITE WF Tools
   :PROPERTIES:
   ...
   Does the defense work? To examine this, WF attacks are executed
