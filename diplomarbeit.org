...
* WAIT_FINISH Acknowledgements
  - parents H.H. K.K. support
  - Elena encouragement to do this
  - Daniel Arp
...
*** What Happens During a (HTTP) Website Request
    :PROPERTIES:
    :CUSTOM_ID: http
    :END:
...
*** Hurdles to Website Fingerprinting: HTTP Protocol Evolution
    :PROPERTIES:
    :CUSTOM_ID: Hurdles
    :END:
...
*** Challenges to Website Fingerprinting: Tor
    :PROPERTIES:
...
**** Website Fingerprinting Features
     :PROPERTIES:
     :CUSTOM_ID: features
     :END:
...
***** Choice: How to Set Cover Traffic Target Values
      #+INDEX: I
      #+INDEX: flavour!I
      #+INDEX: II
      #+INDEX: flavour!II
...
* Results and Evaluation [38%]                               :results:
...
**** Original Classification Methods: Panchenko and Wang
     :PROPERTIES:
...
*** MOVE integrate to  [[*Closed World Attack Results][Closed World Attack Results]]
