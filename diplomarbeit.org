...
*** Measuring Performance
    ...
    different cases that can occur in \gls{wf}. Each trace is
    categorized by whether it /is/ a sensitive website (here:
    wikipedia.org), and whether it is /classified/ as such. See Table
