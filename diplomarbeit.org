...
** WRITE Website Fingerprinting [17/29]
   :PROPERTIES:
   :CUSTOM_ID: wf
   :END:
*** DANIEL Introduction
...
**** CHECK Preparation
     While Support Vector Machines yield results that often surpass
     other machine learning techniques[fn::see
     f.ex.\cite[sec.7.8.1]{kernels}], they require several
     preprocessing steps that can be omitted for other learning
     methods, such as decision-trees based methods and
     kNN\cite[sec.10.7]{esl}.

     Outlier removal, data normalization and parameter estimation help in
     increasing the accuracy of SVMs.
*** WRITE Wang's KNN
    #+INDEX: attack!kNN
...
* KEYWORDS Results and Evaluation [39%]
** EVA Introduction
