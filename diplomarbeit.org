...
**** CHECK Addon Version: Main
     ...
     size[fn:kg:known or guessed, see next section], and number of
     embedded objects[fn:kg], adding to these to reach target values.
...
***** CHECK Choice: how to set cover traffic target values
      ...
      known.
***** WRITE MOVE UP ONE Choice: Cache (approximate) sizes using Bloom Filters
****** WRITE Introduction
...
*** WRITE MOVE to Defenses outlier removal
