...
* TODO Acknowledgements
  ...
  - Dr. Dr. Eva
* WAIT Summary
* TODO Basics (=basics) [42%]
** WRITE Website Fingerprinting [13/28]
*** DANIEL Introduction
...
*** EVA Aim: selective cover traffic
    ...
    her country.
** TODO Design and Implementation (=Implementation) [9/17]
*** DANIEL Introduction
...
* TODO Results and Evaluation [15%]
** WRITE Setup
*** WRITE sites
...
*** WRITE classification
    ...
    Support Vector Machines need additional parameters as input. These
    are determined in an additional parameter estimation
    step. \cite{Hsu10apractical} recommend grid-search, which is used
    by \cite{panchenko2} and \cite{panchenko}.


    - grid search
      - tested with parameters from list, choose best accuracy
      - on training set
    - analysis: analyse.py
...
* TODO MOVE sub [[*Conclusion][Conclusion]] Future Work
** eval
   :PROPERTIES:
