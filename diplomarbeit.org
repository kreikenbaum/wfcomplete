...
*** Measuring Performance
    ...
    from working, their success needs to be measured. The simplest
    ...
    of measurement, a /confusion matrix/ \citep{powers} helps to
    ...
    - [why is this important?]
      - base rate fallacy: get lost in big number of ...
        - prime example: take cancer example, same number, change words for WF
        - refutations
