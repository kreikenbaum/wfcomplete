...
*** KEYWORDS Introduction
    ...
    these pictures] of the same web page, where box height signifies
...
*** brainstorm                                                      :ARCHIVE:
    ...
    - induce pattern
      ...
      - features
*** WRITE Related Work
    Schneier's seminal book \cite{applied96} /Applied Cryptography/
    deals briefly with /Traffic analysis/, as does /Practical
    Cryptography/ by Ferguson and Schneier\cite{practical}. The first
    mention of applying it against encrypted internet communication
    dates to Wagner and Schneier's analysis of the SSL 3.0
    protocol\cite{SSL}, attributed to Bennet Yee.
