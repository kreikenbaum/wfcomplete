...
* WAIT Acknowledgements
  ...
  - Dr. Dr. Eva
* WAIT Summary
* WRITE Basics (=basics) [38%]
** CHECK Introduction
   To protect their online communication, journalists, whistleblowers,
   "normal people" and even military among others have resorted to the
   Tor anonymity network\cite{who-uses-tor}.
...
** WRITE Website Fingerprinting [14/33]
   :PROPERTIES:
   :CUSTOM_ID: wf
   :END:
*** DANIEL Introduction
...
**** CHECK Multi-Class Strategies
     ...
     fewer samples per fitting.\cite[sec.4.12.3]{sklearn}.
**** WRITE Kernel Trick
...
**** WRITE Original Classification Methods: Panchenko and Wang's
 ...
 treatment.
     ...
     - panchenko: 2016 data set plus code
       ...
       - 10-fold cv with /no/ previous splitting of train and test data
         for parameter estimation (unlike [[#split][split]])
