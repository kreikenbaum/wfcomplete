...
** How Tor Works
  ...
  #+CAPTION[Tor Network]: Tor Network. Tor-protected links are dashed and lime. Onion icon marks Tor servers, copyright the Tor project, inc. Inspired by \href{https://upload.wikimedia.org/wikipedia/commons/a/a1/How_Tor_Works_3.svg}{Wikipedia}.
...
[[./pictures/total_packets_in_disabled___bridge--2016-07-06_tamaraw_wtf-pad___bridge--2016-07-05__msn.com_buzzfeed.com_youtube.com_xvideos.com__palette_colorblind.pdf]]
   ...
   As seen in Figure [[fig:total_packets_in]], \citet{wtfpad2015}'s
   implementation of WTF-PAD and Tamaraw \citep{a-systematic2014} both
   create additional packets, but preserve site separation and
   ordering.
   ...
   its prototype status \citep{LLaMA}.
* A New Defense
...
\citet{DBLP:journals/popets/CherubinHJ17}, which was published during
...
\citet{panchenko}'s camouflage traffic, but it only sends single
requests, and it sends until the original retrieval is
finished. (Additionally, page characteristics are cached to more
accurately send cover traffic.)
